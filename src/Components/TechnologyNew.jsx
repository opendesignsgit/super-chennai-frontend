...
export default function Technologynewchennai() {
  ...
  const data = [
    {
      indicator: "Brainpower",
      advantage: "Engineers from IIT Madras, Anna University, SRM, and more fuel the startup and IT ecosystems",
      advantage1: "2M+ learners; vernacular-first approach",
    },
    {
      indicator: "Full-Stack Capability",
      advantage: "From hardware design to cloud platforms, product companies to R&D labs — everything co-exists",
      advantage1: "$17M+ raised; India + US learner base",
    },
    {
      indicator: "Deep Thinking",
      advantage: "Chennai startups go deep: AI, robotics, quantum computing, fintech infrastructure, and more",
      advantage1: "Global expansion, Chennai origin",
    },
    {
      indicator: "SaaS DNA",
      advantage: "Chennai gave India its first SaaS unicorn (Freshworks), and continues to lead in B2B software",
      advantage1: "Scaling with corporate partners",
    },
    {
      indicator: "Sustainable Tech",
      advantage: "Clean energy, green mobility, and GovTech apps are gaining serious traction",
      advantage1: "Focused on Gen Z learning models",
    },
    {
      indicator: "Collaborative Culture",
      advantage: "Strong support from incubators like IITM Research Park, TIDCO, and FinBlue innovation hub",
      advantage1: "Focused on Gen Z learning models",
    },
  ];
  ...
  const data1 = [
    {
      indicator: "Talent Density",
      advantage: "200+ engineering colleges, IIT-M, IIIT-DM, SRM — a deep tech talent pool",
      advantage1: "Iron Pillar, Y Combinator, angels",
    },
    {
      indicator: "Affordability",
      advantage: "30–50% lower cost of scaling ops vs Bangalore or Mumbai",
      advantage1: "IITM Incubation, BIRAC, VCs",
    },
    {
      indicator: "SaaS Capital",
      advantage: "High retention, high output, low overheads — ideal for B2B scaling",
      advantage1: "Exit valued at ~$600M",
    },
    {
      indicator: "Policy Support",
      advantage: "TN Startup Mission, FinBlue, MeitY CoEs, TIDCO, Guidance TN",
      advantage1: "Bootstrapped, angel-backed",
    },
    {
      indicator: "Infrastructure",
      advantage: "Tier-1 data centers, IT parks (TIDEL, SIPCOT), 5G corridors, metro rail connectivity",
          ...
          points: [
            {
              ...
              para: [
                <>
                  <strong>3rd largest tech workforce</strong> in India
                </>,
                <>
                  <strong>Thousands of IT, SaaS, and engineering companies</strong> across the city
                </>,
                <>
                  Ranked among <strong>Top 5 cities in Asia</strong> for emerging startup ecosystems
                </>,
                <>
                  <strong>Chennai-born SaaS</strong> products now power global businesses
                </>,
                <>
                  <strong>100+ Fortune 500 companies</strong> have a tech footprint here
                </>,
              ],
              imgs: "/images/Invest-Images/invest-icons/tech/Built-on-Strong-Foundations.svg",
            },
          ],
        },
      ],
          ...
          points: [
            {
              ...
              para: [
                <>
                Home to India’s first SaaS unicorn – <strong>Freshworks</strong>
                </>,
                <>
                Other major players: <strong>Zoho, Chargebee, Kissflow, Facilio</strong>
                </>,
                <>
                World-class product thinking, low churn rates, high LTV models
                </>,
                <>
                Chennai powers <strong>over 40%</strong> of India’s B2B SaaS exports
                </>,
              ],
              imgs: "/images/Invest-Images/invest-icons/tech/SaaS-B2B-Software.svg",
            },
          ],
        },
        {
          points: [
            {
              title: "DeepTech, AI & R&D",
              para: [
                <>Global research centers: <strong>Google, Cisco, Samsung, Saint-Gobain</strong></>,
                <>IIT-Madras is building India’s <strong>largest AI research cluster</strong></>,
                <>
                  R&D parks at Taramani, IITM RP, and SRM Innovation Zone
                </>,
                <>
                 Active startups in NLP, vision tech, robotics, and quantum
                </>,
              ],
              imgs: "/images/Invest-Images/invest-icons/tech/DeepTech-AI-R&D.svg",
            },
          ],
        },
        {
          points: [
            {
              ...
              para: [
                <>
                  Chennai startups are innovating in: digital lending, neo-banking, wealth tech
                </>,
                <>
                  Home to <strong>Open Financial, Kaleidofin, Crediwatch</strong>
                </>,
                <>
                  Close proximity to financial hubs like Mumbai via digital-first models
                </>,
              ],
              imgs: "/images/Invest-Images/invest-icons/tech/FinTech.svg",
            },
          ],
        },
        {
          points: [
            {
              ...
              para: [
                <>Chennai’s hospitals + tech = fertile ground for digital health</>,
                <>Startups in diagnostics AI, surgical robotics, remote health monitoring</>,
                <>Ties with MedIndia, Kauvery Digital Health, Dozee</>,

              ],
              imgs: "/images/Invest-Images/invest-icons/tech/HealthTech-MedTech.svg",
            },
          ],
        },
        {
          points: [
            {
              title: "Gaming, Media & Entertainment Tech",
              para: [
                <>AR/VR game studios, VFX pipelines, mobile gaming startups</>,
                <>Emerging creative tech corridor in Perungudi & Porur</>,
                <>Chennai-based teams contributing to global OTT platforms</>,

              ],
              imgs: "/images/Invest-Images/invest-icons/tech/Gaming-Media-Entertainment-Tech.svg",
            },
          ],
        },
        {
          points: [
            {
              title: "Industrial & Embedded Tech",
              para: [
                <>Chennai is India’s auto & electronics capital — tech meets manufacturing</>,
                <>IoT, mechatronics, and embedded systems in Sriperumbudur & Oragadam</>,
                <>R&D centers of Bosch, Hyundai, Foxconn, and Visteon</>,

              ],
              imgs: "/images/Invest-Images/invest-icons/tech/Industrial-Embedded-Tech.svg",
            },
          ],
        },
        {
          points: [
            {
              ...
              para: [
              <><strong>OMR (IT Corridor)</strong> – The original tech spine of the city</>,
              <><strong>Taramani</strong> – Home to India's first and largest tech park (TIDEL)</>,
              <><strong>Ambattur</strong> – Fast-rising zone for cost-effective IT and SaaS offices</>,
              <><strong>Siruseri SIPCOT</strong> – Mega campuses, MNCs, and electronics majors</>,
              <><strong>Guindy & Porur</strong> – Hotspots for product companies and GCCs</>,
              ],
              imgs: "/images/Invest-Images/invest-icons/tech/Where-It-All-Happens.svg",
            },
          ],
        },
        {
          points: [
            {
              ...
              para: [
              <>Chennai is projected to add <strong>10+ lakh new tech jobs </strong>in the next 7 years</>,
              <>AI, robotics, and industry-grade R&D will drive the <strong>next wave of innovation</strong></>,
              <>Global Tech Captive Centers (GCCs) are choosing Chennai for scale + skill</>,
              <>Increasing <strong>VC interest in Chennai-based deeptech & SaaS startups</strong></>,
              <>State support for <strong>Tech Parks 2.0</strong>, Fab Labs, and Innovation Zones</>,
              ],
              imgs: "/images/Invest-Images/invest-icons/tech/Whats-Coming-Next.svg",
            },
          ],
        },
      ],
  ...
  return (
    <>
      ...
      <div className="accaodomationBannerSection">
        <img src="/images/education/tech.jpg" alt="" />
        <div className="accodoamationBannerContainer">
          <div className="accodoamationBannerText">
            <h3>Tech Chennai</h3>
            <div className="breadCrum">
              <Link to="/">Home</Link> - <span> tech chennai</span>
            </div>
          </div>
        </div>
      ...
      <div className="visitIntroParaSection detailIntro">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="workIntro">
            <h3>Where Legacy Meets Leap — A City Building India’s Digital Backbone</h3>
            <p>
             Chennai has quietly but powerfully become one of India’s most dependable technology hubs. Unlike flashy hype cycles, this city builds with depth, with resilience, and with vision. From mainframes in the '90s to SaaS unicorns and AI labs today, Chennai’s tech story is rooted in engineering-first thinking and world-class talent.
            </p>
          </div>
        </div>
      </div>
        ...
        <section className="bg-white py-12 px-4 md:px-8">
          <div className="max-w-6xl mx-auto text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">
              What Makes Chennai’s Tech Scene Unique?
            </h2>
          </div>
