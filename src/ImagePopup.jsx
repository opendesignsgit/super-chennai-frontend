...
const ImagePopup = ({ onClose, imageUrl }) => {
  ...
  return (
    <div className="fixed popupImageBackground inset-0 bg-black bg-opacity-60 flex justify-center items-center z-[9999] transition-opacity duration-300 ease-in-out">
      <div
      ...
      >
        ...
        >
          ...
          <Link to="/reimagine-chennai-AI-art-challenge" onClick={onClose}>
            <img
              src={imageUrl}
              alt="Popup"
