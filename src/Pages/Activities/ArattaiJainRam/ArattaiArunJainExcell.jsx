...
export default function ArattaiArunJainExcell() {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await axios.get(
        "https://api.superchennai.com/api/arattai-arun-jain/arattai-arun-jain"
      );
      ...
      console.error("Error fetching Arun Jain data", err);
    } finally {
      setLoading(false);
    }
  };
