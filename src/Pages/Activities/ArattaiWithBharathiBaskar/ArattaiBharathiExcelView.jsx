...
export default function ArattaiBharathiExcelView() {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await axios.get(
        "https://api.superchennai.com/api/arattai-bharathi/arattai-bharathi",
      );
      ...
      console.error("Error fetching Arattai Bharathi data", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50">
      {/* Premium Banner */}
      <section className="relative overflow-hidden bg-gradient-to-br from-purple-955 via-indigo-950 to-rose-955 bg-indigo-950">
