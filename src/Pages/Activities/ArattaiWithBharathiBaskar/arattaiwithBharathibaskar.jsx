  ...
  return (
    <>
      ...
      <section
        ...
        onClick={scrollToRegister} ref={registerRef}
      >
        <img
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="InvestChennaiContent-conclaves ">
              ...
              <p className="text-gray-600 text-justify md:text-left leading-6 mb-6">
                Bharathy Bhaskar is one of Tamil Nadu's most admired motivational speakers, television personalities, corporate leaders, and authors. With an outstanding academic foundation from Anna University and an accomplished career in the banking sector, she has successfully combined professional excellence with a passion for inspiring people. Her ability to transform everyday experiences into meaningful life lessons has made her a respected voice among audiences of all ages.
              </p>
              <p className="text-gray-600 text-justify md:text-left leading-6 mb-6">
              ...
              <p className="text-gray-600 text-justify md:text-left leading-6 mb-6 font-semibold text-rose-600"ref={registerRef}>
