...
const mockUpcomingEvents = [
  { id: 1, image: "/images/Sriram-gallery/sriram (1).png" },
  { id: 2, image: "/images/Sriram-gallery/sriram (2).png" },
  { id: 3, image: "/images/Sriram-gallery/sriram (3).png" },
  { id: 4, image: "/images/Sriram-gallery/sriram (4).png" },
  { id: 5, image: "/images/Sriram-gallery/sriram (5).png" },
  { id: 6, image: "/images/Sriram-gallery/sriram (6).png" },
  { id: 7, image: "/images/Sriram-gallery/sriram (7).png" },
  { id: 8, image: "/images/Sriram-gallery/sriram (8).png" },
  { id: 9, image: "/images/Sriram-gallery/sriram (9).png" },
  { id: 10, image: "/images/Sriram-gallery/sriram (10).png" },
  { id: 11, image: "/images/Sriram-gallery/sriram (11).png" },
  { id: 12, image: "/images/Sriram-gallery/sriram (12).png" },
  { id: 13, image: "/images/Sriram-gallery/sriram (13).png" },
];
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Super Chennai Arattai with V. Sriram Heritage Historian</title>
        <meta
          name="description"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 lg:px-0">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* D:\projects\super-chennai-frontend\public\images\Sriram-gallery */}
          </div>
        </div>
      </section>
