...
export default function ArattaiWithKishenDas() {
  ...
  const arattaiSchema = [
    {
      ...
      image:
        "https://www.superchennai.com/images/kishedndas-desktop-banner.jpeg",
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Super Chennai Arattai with Actor & Podcaster Kishen Das</title>
        <meta
          name="description"
          content="Actor and podcaster Kishen Das joins Super Chennai Arattai to talk Mudhal Nee Mudivum Nee, Timepass with Das, Menu Please, and his digital-to-film journey."
        />
      ...
      {/* ================= BANNER ================= */}
      <section
        className="accaodomationBannerSection relative overflow-hidden cursor-pointer kishendasmain"
        onClick={scrollToRegister}
      >
        <img
          className="hidden sm:block w-full kishendas-desktop"
          // src="/images/vivek-banner.jpeg"
          src="/images/kishedndas-desktop-banner.jpeg"
          alt="Arattai Event"
        />
        <img
          className="block sm:hidden w-full kishendas-mobile"
          src="/images/kishedndas-mobile-banner.jpeg"
          alt="Arattai Event"
        />
      </section>
        ...
        <div className="container mx-auto px-6 lg:px-0">
          <div className="max-w-4xl mx-auto text-center">
            <div className="InvestChennaiContent-conclaves ">
              <h1 className=" text-center hidden ">Arattai with Kishen Das</h1>
              <h3>Arattai with Kishen Das</h3>

              <p className="text-gray-600 leading-relaxed mb-6 ">
                From viral videos to the big screen, Kishen Das has carved a
                unique space for himself as one of Tamil entertainment's most
                relatable and versatile young talents. What began as a digital
                content journey quickly evolved into a multifaceted career
                spanning acting, hosting, podcasting, and storytelling. Known
                for his effortless charm, sharp wit, and authentic personality,
                Kishen has built a strong connection with audiences who have
                followed his evolution from internet favorite to rising star.
              </p>
              ...
              <p
                ...
                ref={registerRef}
              >
                Beyond cinema, Kishen has become a familiar voice and face
                through his Spotify Original podcast{" "}
                <strong> Timepass with Das </strong> and the widely loved
                interview series <strong> Menu Please, </strong> where candid
                conversations meet compelling storytelling. Having shared
                conversations with celebrated personalities such as Anil Kapoor,
                Shahid Kapoor, and Vijay Sethupathi, he brings a refreshing
                perspective to every interaction. At Arattai, we're excited to
                welcome Kishen Das for an engaging conversation about
                creativity, cinema, content, and the experiences that shaped his
                remarkable journey.
              </p>
            </div>
            {/* <div className="flex flex-col items-center text-center space-y-4 py-6">
              ...
              <h2 className="themelink-color formheadingtheme-arattai">
                Join Us for a Conversation with Kishen Das
              </h2>

              <p className="text-gray-600 text-lg">
                On 13<sup>th</sup> June
              </p>
