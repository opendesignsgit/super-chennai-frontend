...
export default function ArattaiWithSamhithaMoturi() {
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      await axios.post(
        `${API_BASE_URL_API}/arattai-samihitha/arattai-samihitha/send-otp`,
        {
  ...
  const submitArattaiForm = async (e) => {
    ...
    try {
      ...
      await axios.post(
        `${API_BASE_URL_API}/arattai-samihitha/arattai-samihitha/verify-otp`,
        payload,
      );
      ...
      navigate("/thank-you", { state: { from: "sahitha" } });
    } catch (err) {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          Arattai with Dr. Samhitha Moturi Director of Prashanth Hospitals
        </title>
        <meta
          name="description"
          content="Be part of Super Chennai Arattai as Dr. Samhitha Moturi discusses healthy living, women’s wellness and practical ways to maintain long-term well-being."
        />
      ...
      >
        <img
          ...
          src="/images/innerpage-banner-samhita.jpeg"
          alt="Arattai Event"
        />
        <img
          className="block sm:hidden w-full"
          src="/images/mobile-samhita-banner.jpeg"
          alt="Arattai Event"
        />
      </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="InvestChennaiContent-conclaves ">
              <h1 className=" text-center hidden ">
                Arattai with Dr. Samhitha Moturi
              </h1>
              <h3>Arattai with Dr. Samhitha Moturi</h3>
              <p className="text-gray-600 text-justify md:text-left leading-6 mb-6">
                Join Arattai with Dr. Samhitha Moturi, Director of Prashanth
                Group of Hospitals, as she shares valuable insights on
                reproductive health, stress management, hormonal wellness, and
                sustainable self-care.
              </p>
              <p className="text-gray-600 text-justify md:text-left leading-6 mb-6">
                Discover why prioritizing well-being is just as important as
                pursuing ambition—and how the right balance can help you thrive
                through every stage of life.
              </p>
              <p className="text-gray-600 text-justify md:text-left leading-6 mb-6">
                Behind every achievement is a woman balancing multiple roles,
                responsibilities, and expectations. While ambition fuels
                success, the demands of modern urban life can often affect
                physical and emotional well-being, making self-care and health
