...
const foodItems = [
  {
    title: "ITALIAN",
    description:
      "Chennai’s growth must be inclusive, resilient, and equitable. This pillar focuses on building a city that delivers quality of life for all residents.Key areas include sustainable mobility, affordable housing, flood resilience, clean public spaces, strong civic governance, and neighbourhoods designed for safety and accessibility",
  ...
  {
    title: "JAPANESE",
    description: "Fresh sushi, warm ramen, crispy tempura, delicate flavors.",
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition">
                  ...
                  <p className="text-sm text-gray-600">
                    Building resilient, inclusive and future-ready urban systems
                    for Chennai.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition">
                  ...
                  <p className="text-sm text-gray-600">
                    Driving innovation, entrepreneurship and inclusive economic
                    development.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition">
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-purple-100 mb-4">
                    ...
                    >
                      ...
                      <path d="M12 12l5 8H7l5-8z" />
                    </svg>
                  </div>
                  <h4 className="font-semibold text-lg mb-2">Sustainability</h4>
                  <p className="text-sm text-gray-600">
                    Climate action, green mobility and sustainable urban living.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition">
                  ...
                  <p className="text-sm text-gray-600">
                    Transparent governance and data-driven policy making.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition">
                  ...
                  <h4 className="font-semibold text-lg mb-2">Social Equity</h4>
                  <p className="text-sm text-gray-600">
                    Ensuring equal access to opportunities, services and safety.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition">
                  ...
                  <p className="text-sm text-gray-600">
                    Celebrating Chennai’s heritage while embracing global
                    perspectives.
                  </p>
                </div>
              </div>
