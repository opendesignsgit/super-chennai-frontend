...
export default function MazzaRegister() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      await API.post("/auth/majaa/send-otp-mobile", {
        phone: form.phone,
        name: form.name,
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await API.post("/auth/majaa/register-with-otp", {
        name: form.name,
        phone: form.phone,
        otp,
      });
