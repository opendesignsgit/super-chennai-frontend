...
// export default function Login2026({ setIsLoggedIn }) {
...
//                 // onClick={() => navigate("/login-otp2026")}
//                 onClick={routefunction}
//                 className="bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 transition-colors font-semibold mb-6 theme-button-small cursor-pointer mt-3"
//               >
//                 Start Quiz
//               </button> */}
//               <button
...
//               </li>
//               <li>
//                 Timing matters: Voting is open from 8:00 AM to 8:00 PM only.
//               </li>
//               <li>
//                 Winners are selected based on speed and accuracy - so don’t
//                 wait! Vouchers are non-transferable and cannot be exchanged for
//                 cash.
//               </li>
//               <li>The organizer’s decision will be final in all cases.</li>
//             </ul> */}
