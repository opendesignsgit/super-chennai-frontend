  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-stretch bg-[#fff] rounded-2xl overflow-hidden shadow-lg border border-gray-100">
        ...
        {/* Right Side - Registration Closed Content */}
        <div className="w-full md:w-7/12 p-8 md:p-12 flex flex-col justify-center items-center text-center contactssssform bg-slate-50/50">
          ...
          {/* Main Headings */}
          <h2 className="headingsection text-2xl md:text-3xl font-extrabold text-[#01236a] tracking-tight">
            REGISTRATION IS CLOSED
          </h2>
          
          <p className="mt-2 text-gray-600 text-base md:text-lg max-w-md font-medium">
            Thank you for the overwhelming response! All available slots for <span className="font-semibold text-slate-800">Sing Along Metro</span> have been completely filled.
          </p>
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm max-w-lg w-full text-left space-y-2">
            <p className="text-sm text-gray-700 font-semibold flex items-center gap-2">
              <span className="text-amber-500 text-base">✨</span> Missed your spot?
            </p>
