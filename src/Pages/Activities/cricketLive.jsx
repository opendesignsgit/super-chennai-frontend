...
const cards = [
  ...
  {
    title: "FAN ZONE",
    subtitle: "Vibe. Cheer. Repeat.",
    className: "card-purple"
  },
  {
    title: "WATCH PARTY",
    subtitle: "Big Screen. Bigger Thrills.",
    className: "card-red"
  },
  {
    title: "MATCH DAY BITES",
    subtitle: "Eat. Cheer. Repeat.",
  ...
  return (
    <section className="ipl-section">
      ...
      <div className="ipl-header">
        ...
        <h2>IPL MATCH</h2>
        <p>
          Chennai is buzzing with IPL fever! Experience matches, fan zones,
          watch parties, and celebrations across the city.
        </p>
      </div>
      ...
      <div className="ipl-container">
        ...
        {/* LEFT HERO */}
        <div className="ipl-left">
          <img src="/images/ipl-hero.jpg" alt="IPL Chennai" />
          <div className="overlay-text">
            <h3>IPL LIVE FROM</h3>
            <h1>CHENNAI!</h1>
            <p>Feel the roar. Feel the game.</p>
          </div>
        </div>
        ...
        <div className="ipl-cards">
          {cards.map((card, index) => (
            <div key={index} className={`ipl-card ${card.className}`}>
