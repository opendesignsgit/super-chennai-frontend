        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 pt-8 pb-10 h-full w-full flex flex-col justify-center">
          ...
          <nav className="text-gray-400 neighbourtwoparagraph items-center gap-1 neighbourhoodbrudcrum">
            <div className="flex flex-wrap gap-2 mb-5">
              ...
              {/* 4. Current Page (Active link - text-white, non-clickable for UX) */}
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm max-w-2xl mb-7 leading-relaxed neighbourtwoheaidngssparagraph">
              This is the Static Data Please Address Bharathi
            </p>
            ...
            {/* Search component-ai inge use seiyalam */}
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-10">
        ...
        <section>
          ...
          <div className="grid grid-cols-3 gap-3 neighbourhoodfirstttt">
            ...
            {filtered.slice(0, 1).map((item) => (
              <div
                key={item.id || item.slug} // Good practice: Always add a unique key when mapping
                onClick={() =>
                  navigate(
            ...
            <div className="col-span-1 flex flex-col gap-3 neighsecondsssimageee">
              {filtered.slice(1, 3).map((item) => (
                <div
                  key={item.id || item.name} // item.id is safer if item.name isn't unique
                  onClick={() =>
                    navigate(
                      `/neighbourhood/${locationId}/${safeCategory}/${safeSubcategory}/${item.slug}`,
                    )
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
            {/* Ippo dynamic-a sortedAndFiltered map panrom */}
          ...
          {/* <div className="mt-10 flex justify-center ">
            <button className="cursor-pointer border border-gray-300 text-gray-700 hover:border-[#a44294] hover:text-[#a44294] px-8 py-2.5 rounded-full text-sm font-medium transition-colors">
              View More Places
            </button>
          </div> */}
        </section>
