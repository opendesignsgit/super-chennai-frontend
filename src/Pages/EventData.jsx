...
export const prideofchennaidata = [
  ...
  },
  {
    ...
    bornPlace: "West Mambalam, Chennai, Tamil Nadu",
    natureofWork: "Right-arm off-spin bowler, Right-hand lower-order batsman",
    about: "Indian international cricketer and one of the greatest spinners.",
    knowmoreLink: "",
    popupContent: [
      <>Fastest Indian to 500 Test wickets.</>,
      <>
        Only Indian to score a century and take 5 wickets in a Test match four
        times.
      </>,
    ],
    category: "Cricketers",
  ...
  {
    image: "/images/pride-of-chennai/bhupathi.jpg",
    name: "Mahesh Bhupathi",
    profession: "Tennis Player",
    bornPlace: "Chennai, Tamil Nadu",
    natureofWork: "Professional tennis player, Grand Slam winner",
    about: "First Indian to win a Grand Slam tournament.",
    knowmoreLink: "",
    popupContent: [
      <>Won mixed doubles titles at all four Grand Slams.</>,
      <>Partnered with Leander Paes to win multiple doubles titles.</>,
    ],
    category: "Tennis",
  },
  {
    ...
    bornPlace: "Mayiladuthurai, Tamil Nadu (raised in Chennai)",
    natureofWork: "Five-time World Chess Champion",
    about: "India's first Chess Grandmaster and former World Champion.",
    knowmoreLink: "",
    popupContent: [
      <>Became a Grandmaster at the age of 18.</>,
      <>Won the FIDE World Championship 5 times.</>,
    ],
    category: "Chess",
  },
  {
    image: "/images/pride-of-chennai/srinivasa-ramanujan.jpg",
    name: "Srinivasa Ramanujan",
    profession: "Mathematician",
    bornPlace: "Erode, Tamil Nadu",
    natureofWork:
      "Mathematical genius with vast contributions to number theory",
    about: "Renowned for his deep and intuitive insights in pure mathematics.",
    knowmoreLink: "",
    popupContent: [
      <>
        Contributed over 3,900 results to mathematics despite no formal
        training.
      </>,
  ...
  {
    image: "/images/pride-of-chennai/apj-abdul-kalam.jpg",
    name: "Dr. A.P.J. Abdul Kalam",
    profession: "Scientist, Former President of India",
    bornPlace: "Rameswaram, Tamil Nadu",
    natureofWork: "Aerospace Scientist, Missile Man of India",
    about: "Served as the 11th President of India and led major ISRO missions.",
    knowmoreLink: "",
    popupContent: [
      <>Key role in India's nuclear and space programs.</>,
      <>
        Known for his inspirational youth outreach and scientific leadership.
      </>,
    ],
    category: "Science and research",
  },
  {
    image: "/images/pride-of-chennai/harris-jayaraj.jpg",
    name: "Harris Jayaraj",
    profession: "Music Director",
    bornPlace: "Chennai, Tamil Nadu",
    natureofWork: "Film composer and music producer",
    about: "Popular for melodious compositions in Tamil cinema.",
    knowmoreLink: "",
    popupContent: [
      <>Debuted with "Minnale" in 2001 which was a massive hit.</>,
      <>Won multiple Filmfare and Vijay Awards for music direction.</>,
    ],
    category: "Entertainment",
  },
  {
    image: "/images/pride-of-chennai/ar-rahman.jpg",
    name: "A.R. Rahman",
    profession: "Music Composer",
    bornPlace: "Chennai, Tamil Nadu",
    natureofWork: "Internationally acclaimed composer and performer",
    about: "Known as the Mozart of Madras.",
    knowmoreLink: [
      <>Won two Academy Awards for "Slumdog Millionaire".</>,
      <>Revolutionized Indian film music with his unique style.</>,
    ],
    category: "Entertainment",
  },
  {
    image: "/images/pride-of-chennai/sundar-pichai.jpg",
    name: "Sundar Pichai",
    profession: "CEO of Google and Alphabet",
    bornPlace: "Madurai, Tamil Nadu (raised in Chennai)",
    natureofWork: "Technology executive",
    about:
      "Led the development of Google Chrome, Android, and now heads Alphabet.",
    knowmoreLink: "",
    popupContent: [
      <>Became CEO of Google in 2015 and Alphabet in 2019.</>,
      <>Known for his leadership in AI and product innovation.</>,
    ],
    category: "Social/ Tech /Chef",
  },
  {
    image: "/images/pride-of-chennai/silambarasan.jpg",
    name: "Silambarasan (Simbu)",
    profession: "Actor, Singer",
    bornPlace: "Chennai, Tamil Nadu",
    natureofWork: "Actor, playback singer, director",
    about: "Popular for his versatility in Tamil cinema.",
    knowmoreLink: "",
    popupContent: [
      <>Rose to fame with "Manmadhan" and "Vinnaithaandi Varuvaayaa".</>,
      <>Also known for his singing and directing talents.</>,
    ],
    category: "Entertainment",
  },
  {
    image: "/images/pride-of-chennai/dhanush.jpg",
    name: "Dhanush",
    profession: "Actor, Producer, Singer",
    bornPlace: "Chennai, Tamil Nadu",
    natureofWork: "Multi-talented performer in Tamil cinema",
    about: "National Award-winning actor and global artist.",
    knowmoreLink: "",
    popupContent: [
      <>Won National Awards for "Aadukalam".</>,
      <>Starred in international projects like "The Gray Man".</>,
    ],
    category: "Entertainment",
  },
  {
    image: "/images/pride-of-chennai/hima-das.jpg",
    name: "Revathi Veeramani",
    profession: "Athlete",
    bornPlace: "Madurai, Tamil Nadu",
    natureofWork: "Sprinter, 400m & Relay athlete",
    about: "Part of Indian women’s relay team at Asian Games.",
    knowmoreLink: "",
    popupContent: [
      <>Gold medalist in the 4x400m mixed relay at Asian Games 2023.</>,
    ],
    category: "Sports",
  },
  {
    image: "/images/pride-of-chennai/sathish-sivalingam.jpg",
    name: "Sathish Sivalingam",
    profession: "Weightlifter",
    bornPlace: "Vellore, Tamil Nadu",
    natureofWork: "Weightlifting champion",
    about: "Two-time Commonwealth Games gold medalist.",
    knowmoreLink: "",
    popupContent: [<>Won gold in 2014 and 2018 Commonwealth Games.</>],
    category: "Bodybuilding",
  },
  {
    image: "/images/pride-of-chennai/chef-damu.jpg",
    name: "Chef Damu",
    profession: "Celebrity Chef",
    bornPlace: "Chennai, Tamil Nadu",
    natureofWork: "Television chef, record holder",
    about: "Holds Guinness World Record for longest cooking marathon.",
    knowmoreLink: "",
    popupContent: [
      <>Cooked continuously for 24 hours and 30 minutes.</>,
      <>Known for spreading Tamil cuisine globally.</>,
    ],
    category: "Social/ Tech /Chef",
  },
  {
    image: "/images/pride-of-chennai/priyanka.jpg",
    name: "Priyanka Deshpande",
    profession: "TV Anchor",
    bornPlace: "Chennai, Tamil Nadu",
    natureofWork: "Television anchor and host",
    about: "One of the most popular TV personalities in Tamil Nadu.",
    knowmoreLink: "",
    popupContent: [<>Host of shows like Super Singer and Bigg Boss Tamil.</>],
    category: "Entertainment",
  },
  {
    image: "/images/pride-of-chennai/kamal-haasan.jpg",
    name: "Kamal Haasan",
    profession: "Actor, Director, Politician",
    bornPlace: "Paramakudi, Tamil Nadu",
    natureofWork: "Award-winning actor and film legend",
    about: "Has contributed immensely to Indian cinema for over 60 years.",
    knowmoreLink: "",
    popupContent: [
      <>Received multiple National Film Awards.</>,
      <>Known for roles in classics like "Nayakan", "Indian", "Vikram".</>,
    ],
    category: "Entertainment",
  },
  {
    image: "/images/pride-of-chennai/bharathidasan.jpg",
    name: "Bharathidasan",
    profession: "Poet, Writer",
    bornPlace: "Puducherry (Influenced by Chennai)",
    natureofWork: "Tamil poet and activist",
    about: "Known for revolutionary Tamil poems and literature.",
    knowmoreLink: "",
    popupContent: [<>His works inspired the Tamil language movement.</>],
    category: "Literature",
  },
  {
    ...
    name: "Ilaiyaraaja",
    profession: "Music Composer",
    bornPlace: "Pannaipuram, Tamil Nadu",
    natureofWork: "Composer, singer, instrumentalist",
    about: "Composed over 7,000 songs in multiple languages.",
    knowmoreLink: "",
    popupContent: [
      <>
        First Asian composer to score a symphony with Royal Philharmonic
        Orchestra.
      </>,
    ],
    category: "Entertainment",
  },
  {
    ...
    name: "MS Dhoni",
    profession: "Cricketer",
    bornPlace: "Ranchi (Adopted by Chennai Super Kings)",
    natureofWork: "Former India Captain & CSK Icon",
    about: "Beloved by Chennai for his IPL legacy.",
    knowmoreLink: "",
    popupContent: [
      <>Won 5 IPL titles with Chennai Super Kings.</>,
      <>Led India to World Cup, Champions Trophy and T20 victories.</>,
    ],
    category: "Cricketers",
  },
  {
    image: "/images/pride-of-chennai/rajinikanth.jpg",
    name: "Rajinikanth",
    profession: "Actor",
    bornPlace: "Bangalore (Career in Chennai)",
    natureofWork: "Superstar of Tamil cinema",
    about: "Icon of South Indian cinema and cultural phenomenon.",
    knowmoreLink: "",
    popupContent: [<>Known for iconic roles and mass appeal.</>],
    category: "Entertainment",
  },
  {
    image: "/images/pride-of-chennai/k-s-chithra.jpg",
    name: "K. S. Chithra",
    profession: "Playback Singer",
    bornPlace: "Kerala (career based in Chennai)",
    natureofWork: "Playback singer with thousands of songs",
    about: "Fondly known as the Nightingale of South India.",
    knowmoreLink: "",
    popupContent: [
      <>Winner of 6 National Awards and Padma Bhushan recipient.</>,
    ],
    category: "Entertainment",
  },
];
