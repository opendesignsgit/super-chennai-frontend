                ...
                return (
                  <div key={i} className="relative w-full h-[73px]">
                    <img
                      ...
                      alt=""
                      className="w-full h-full min-w-[120px] max-w-[300px] object-cover rounded-lg cursor-pointer"
                      onClick={() => {
          ...
          {isModalOpen && (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
              ...
              <div className="relative w-full max-w-4xl max-h-[90vh] bg-gray-900 rounded-xl shadow-2xl overflow-hidden flex flex-col">
                ...
                <div
                  className="mt-3 mb-4 flex gap-2 overflow-x-auto px-2 cursor-grab active:cursor-grabbing select-none thin-scroll"
                  onMouseDown={(e) => {
