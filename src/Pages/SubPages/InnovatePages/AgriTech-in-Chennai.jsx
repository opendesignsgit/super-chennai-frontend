        ...
        points: [
          {
            ...
            para: [
             <>Deep pool of software engineers and data scientists in precision agriculture</>,
  <>Presence of agri-focused R&D labs, academic institutions, and IoT makers</>,
  <>Strong logistics & cold-chain infra to support farm-to-city movement</>,
  <>Tamil Nadu Govt’s push for smart farming schemes and start-up incubation</>,
  <>Home to AgriTech companies impacting over 10 million farmers across India</>,
...
const evData = [
 { company: "AgroStar (Chennai branch)", focus: "Farmer advisory + inputs", highlights: "Serving 5M+ farmers via mobile" },
  { company: "KisanHub", focus: "Crop intelligence", highlights: "Satellite + data dashboards for supply chain forecasting" },
  { company: "FarmAgain", focus: "Precision farming", highlights: "IoT devices + mobile analytics to track soil, water, climate" },
  { company: "RuralBasket", focus: "Direct-to-consumer", highlights: "Farm produce from TN villages delivered to urban buyers" },
  { company: "Triton Foodworks", focus: "Hydroponics", highlights: "Tech-enabled sustainable farming in urban setups" },
  { company: "Aibono", focus: "AI + Yield Prediction", highlights: "Decision science tools for high-value crop planning" },
  { company: "Nanopix", focus: "Image-based grading", highlights: "Camera vision + AI for quality checks of produce" },
  { company: "Ecozen (regional presence)", focus: "Cold-chain & solar infra", highlights: "Solar-powered cold storage, smart pump controllers" },
  { company: "FarmBot India (R&D in Chennai)", focus: "Automation", highlights: "Prototype robotics for small farms and vertical farming" },
  { company: "AgniKul Cosmos (IIT-M)", focus: "Dual-use AI", highlights: "Originally space-tech, now modeling for agri satellite data" },
];
...
const FastFacts = [
 { company: "IoT & Sensors", speciality: "Devices to track soil moisture, pH, nutrient flow built locally" },
  { company: "AI/ML for Farming", speciality: "Predictive models for yield, pest risk, and price volatility" },
  { company: "Supply Chain Tech", speciality: "Cold-chain optimization, route efficiency via Chennai logistics tech" },
  { company: "Farmer FinTech", speciality: "Mobile credit scoring, microloans, crop insurance tools" },
  { company: "E-commerce for Agri", speciality: "Apps connecting rural producers directly to urban customers" },
 ...
 const FastStats = [
  ...
  { company: "Farmers indirectly served by Chennai-based platforms", speciality: "10M+" },
  { company: "Crops covered by AI analytics tools", speciality: "35+" },
  { company: "Govt investment in Agri Digital Infra", speciality: "₹800+ Cr" },
  { company: "Cold-storage & logistics tech companies with agri focus", speciality: "50+" },
...
const datard = [
  {
    ...
    points: [
      <><strong>IIT Madras</strong>   Working on drones, satellite mapping, and smart irrigation systems </>,
      <><strong>TNAU (Tamil Nadu Agricultural University)</strong> Collaborates with Chennai tech firms for pilot studies</>,
      <><strong>IIT-M Incubation Cell</strong> Hosts startups like AgniKul, FarmAgain, AI agri-models</>,
      <><strong>Tamil Nadu e-Governance Agency (TNeGA)</strong> Using Chennai-built dashboards for farm-level data</>,
    ],
  },
 ];
...
const CuttingEdge = [
  {
    ...
    points: [
      <><strong>Smartphone-based crop advisory</strong> in Tamil with voice bots</>,
      <><strong> Satellite-linked irrigation management</strong> via mobile apps</>,
      <><strong>AI-led demand forecasting</strong> to reduce food wastage</>,
      <><strong>Urban farming tech</strong> (hydroponics, vertical towers) for Chennai’s city limits</>,
      <><strong>Agri NFTs and blockchain pilots</strong> (traceability + produce ownership)</>,
    ],
  },
    {
    title: "What You Can Add to Super Chennai",
    points: [
      <><strong>Interactive AgriTech Directory</strong>  (filter by tech, impact, district) </>,
      <><strong>Founder Explainer Videos</strong> from Chennai-based innovators</>,
      <><strong>Demo Lab Zone</strong> Show IoT sensors, irrigation models, dashboards</>,
      <><strong>State-Farmer-Tech Map</strong> Connect Chennai tech to rural Tamil Nadu</>,
       <><strong>Innovation Timeline</strong> Track growth from basic sensors to AI-forecasting</>,
    ],
  },
 ];
...
const imageSections2 = [
...

  {
    ...
    },
    {
      ...
      para: [
        <>IIT Madras and TNAU explore remote sensing and climate mapping for agriculture.</>,
    ...
    },
    {
      ...
      para: [
        <>First pilot programs for SMS-based crop advisory in Tamil Nadu villages via Chennai tech partners.</>,
        <>Feature phones used to send fertilizer and irrigation alerts to farmers.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>Chennai startups begin building low-cost sensors for soil moisture, weather, and pest prediction.</>,
    ...
    },
    {
      ...
      para: [
        <>FarmAgain and Aibono offer IoT + analytics solutions to farms in Tamil Nadu.</>,
    ...
    },
    {
      ...
      para: [
        <>Local Chennai firms build tech to track and optimize fresh produce delivery to city markets.</>,
        <>Cold-chain startups collaborate with smallholder farmers for reducing wastage.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>Projects on drone spraying, AI-based plant disease detection, and satellite-linked irrigation launched.</>,
        <>IIT-M’s Incubation Cell begins supporting agri-focused tech startups.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>Chennai startups develop yield prediction models for tomato, banana, and rice.</>,
        <>Camera vision tools for quality grading of produce launched (e.g., Nanopix).</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>High demand for direct-to-consumer platforms like RuralBasket and UzhavarBumi.</>,
        <>Farmers embrace mobile-based trading and advisory apps for input access and market linkage.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>Chennai tech companies build dashboards, analytics tools, and farmer record systems for the government.</>,
        <>TNeGA partners with private startups for agri e-governance initiatives.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>Credit scoring tools, digital wallets, and agri-insurance startups begin operations in Chennai.</>,
        <>Farmer lending models launched in districts via mobile KYC and fintech integrations.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>Chennai startups like Triton Foodworks set up tech-enabled greenhouses within city limits.</>,
        <>Hydroponic kits and training offered to schools and community groups for urban agriculture.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>AI dashboards predicting pest cycles, rainfall windows, and market prices used by 1L+ Tamil Nadu farmers.</>,
        <>Tamil voice AI assistants tested in Chennai and surrounding farming regions.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
    {
      ...
      para: [
        <>Government of India partners with IIT Madras and 20+ startups to build a National Agri AI Framework.</>,
        <>Chennai startups begin servicing farmers across 15+ Indian states with AI + IoT solutions.</>,
        <>Launch of “AgriVerse” – a virtual farming simulator platform for training and prediction.</>,
      ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
    },
      {
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Where Traditional Agriculture Meets Modern Intelligence
</h3>
              <p> Though Chennai isn’t an agricultural hub by geography, it has emerged as a tech nerve center for AgriTech innovation — offering AI, IoT, satellite analytics, supply chain tools, and farm fintech that power Tamil Nadu’s and India’s farmlands.
</p>
            </div>
          </div>
        </div>
...
<div className="overflow-x-auto my-6">
      <h2 className="text-2xl font-bold"> What Chennai Brings to the Field</h2>
      ...
      <table className="min-w-full border border-gray-200 divide-y divide-gray-200 text-left mb-10">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="px-4 py-3 text-sm font-semibold text-gray-700">Chennai’s Edge</th>
          </tr>
        </thead>
