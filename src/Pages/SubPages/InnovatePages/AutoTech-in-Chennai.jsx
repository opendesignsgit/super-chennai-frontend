...
const FastFacts = [
  { company: "ePlane Company (IIT-M)", speciality: "Electric flying taxis (urban air mobility)" },
  { company: "Raptee Energy", speciality: "Premium electric motorcycles built in Chennai" },
  { company: "WayCool (via Censa Tech)", speciality: "AI-powered logistics fleet optimization" },
  { company: "E-Motorad (EM)", speciality: "IoT-enabled e-bikes for last-mile delivery" },
  { company: "Micelio Mobility", speciality: "EV ecosystem fund with Chennai presence" },
  { company: "Intelligent Mobility Incubator (IIT-M)", speciality: "Hosts EV, AI, and battery tech startups" },
];
...
const data = [
  {
    title: "IIT Madras – Centre for Battery Engineering and Electric Vehicles (CBEEV)",
    points: [
  ...
  },
  {
    ...
    points: [
      "3,000+ engineers working on software-defined vehicles"
    ]
  },
  {
 ...
 const FastStats = [
  ...
  { company: "ADAS and Connected Mobility patents (2023", speciality: "300+" },
 ];

const HealthTech = [
  { company: "OMR – Taramani to Siruseri", speciality: "Auto R&D, Bosch, Hyundai Labs, EV SaaS" },
  { company: "Maraimalai Nagar – Mahindra World City", speciality: "Renault-Nissan, Ford, Mahindra Valley" },
  { company: "Ambattur – Sriperumbudur Belt", speciality: "Industrial automation, auto electronics" },
  { company: "Guindy – Saidapet", speciality: "Startup co-working & auto SaaS companies" },
  { company: "IIT Madras Zone", speciality: "Battery research, vehicle AI, mobility incubators" },
];
         ...
         <> AI-driven fleet management + logistics prediction</>,
          <> Electric trucks for ports & logistics corridors</>,
           <>  Urban air mobility (UAM) testing zones</>,
            ...
            note2:"From making cars to making them smart — Chennai is the garage of India’s automotive future.",
              imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
          },
        ],
      },
...
const imageSections3 = [
...

  {
    ...
    sectionDesc:
      "From Assembly Lines to Autonomous Tech",
        ...
        points: [
          {
            ...
            para: [
              ...
              "Chennai becomes known as a skilled industrial workforce hub",
               <><strong>Impact:</strong> Chennai lays the foundation for India's auto ecosystem</>
            ],
            imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
          },
          {
    ...
    para: [
      ...
      <><strong>Impact:</strong> The region becomes a key export hub for global OEMs</>
    ],
     imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
  },
  {
    ...
    para: [
      ...
      <><strong>Impact:</strong> Chennai transitions from factory-based to tech-driven production</>
    ],
     imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
  },
  {
    ...
    para: [
      ...
      <><strong>Impact:</strong> Chennai starts becoming a brain hub, not just a build hub</>
    ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
  },
  {
    ...
    para: [
      ...
      <><strong>Impact:</strong> EV infrastructure and battery innovation ecosystem takes off</>
    ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
  },
  {
    ...
    para: [
      ...
      <><strong>Impact:</strong> Chennai becomes a global R&D node for future mobility</>
    ],
     imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
  },
  {
    title: "2025 & Beyond: Chennai Leads India’s AutoTech Renaissance",
    para: [
      ...
      <><strong>Expected Impact:</strong> Chennai becomes the mobility innovation capital of India</>
    ],
      imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
  },
        ],
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>From Steel to Software: Chennai Drives India’s Auto Innovation</h3>
              <p>Chennai is not just an auto manufacturing hub — it’s now a rising AutoTech capital. With global OEMs, smart factories, EV startups, and deep automation labs, the city is driving the future of mobility.
</p>
            </div>
          </div>
        </div>
 ...
 {imageSections.map((section, index) => (
  ...
  <h3 className="text-lg font-semibold mb-2">{item.title}</h3>
    ...
    <div className="overflow-x-auto my-6">
      <h2 className="text-2xl font-bold"> Key AutoTech Companies in Chennai</h2>
...
<div className="overflow-x-auto my-6">
      <h2 className="text-2xl font-bold"> Chennai AutoTech by the Numbers (2024)</h2>
     ...
     <tbody class="divide-y divide-gray-200">
      ...
      <h2 className="text-2xl font-bold text-center mb-6">R&D + Innovation Hotspots</h2>
    ...
    <div className="overflow-x-auto my-6">
     ...
     <div className="overflow-x-auto my-6">
      <h2 className="text-2xl font-bold"> Where AutoTech Thrives in Chennai</h2>
       <table className="min-w-full border border-gray-200 divide-y divide-gray-200 text-left mb-10">
        <thead className="bg-gray-100">
          <tr>
