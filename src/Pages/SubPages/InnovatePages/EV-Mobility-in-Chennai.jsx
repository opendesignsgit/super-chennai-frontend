        ...
        points: [
          {
            ...
            para: [
              <><strong>Home to major EV OEMs –</strong> TVS, Ashok Leyland, Hyundai, Ather</>,
             <><strong>EV-focused parks & clusters –</strong>  300+ acres near Chennai (TIDCO EV Park)</>,
<> <strong>R&D ecosystem – </strong> IIT-Madras, Anna University, Mahindra Research Valley</>,
<> <strong>Charging infra –</strong>  600+ public chargers, rapid growth on OMR & IT corridors</>,
<>  <strong>Production hub</strong> for 2W, 3W, buses, batteries, and even EV SaaS</>,
<> <strong>Exports</strong> to SE Asia, Middle East, Europe from Chennai Port</>,
...
const evData = [
  { company: "TVS Motor", focus: "E-Scooters", highlights: "iQube EV; EV-dedicated facility at Hosur" },
  { company: "Hyundai", focus: "E-cars", highlights: "Manufacturing IONIQ 5, future EV exports" },
  { company: "Ashok Leyland", focus: "Electric Buses", highlights: "Circuit series, Switch Mobility EV arm" },
  { company: "Ather Energy", focus: "Premium E-scooters", highlights: "Factory near Hosur; Chennai is key market" },
  { company: "Ampere Vehicles (Greaves)", focus: "2W EVs", highlights: "Assembly + Battery infra scaling up" },
  { company: "Raptee Energy", focus: "EV Motorcycles", highlights: "HQ in Chennai; high-performance Indian superbike" },
  { company: "Pi Beam", focus: "E-3W & logistics EVs", highlights: "IIT-M startup targeting last-mile logistics" }
];

const startupData = [
  { company: "ePlane Company", focus: "Flying EVs (eVTOL)", highlights: "Urban air mobility prototype in progress" },
  { company: "Causis e-Mobility", focus: "Electric Buses", highlights: "Working with TN govt for fleet transition" },
  { company: "RACEnergy", focus: "Battery swapping", highlights: "Targeting 3-wheelers & fleets" },
  { company: "EVRE", focus: "Charging infra", highlights: "B2B stations, mall & office tie-ups" },
  { company: "GoGreenBOV", focus: "E-bikes", highlights: "Designed for delivery & heavy use" },
  { company: "Exponent Energy", focus: "Fast-charging batteries", highlights: "15-min rapid charge tech, Chennai partners" }
];

const chargingData = [
  { type: "Public Charging", locations: "T. Nagar, Guindy, OMR, Anna Nagar, Velachery, malls, metro stations" },
  { type: "Highway Chargers", locations: "Chennai-Bangalore and Chennai-Trichy highways by Ather, Tata Power" },
  { type: "Battery Swapping Stations", locations: "Auto hubs, EV logistics points (North Chennai, Pallavaram)" },
  { type: "Private + B2B", locations: "Flats, IT parks, logistics warehouses" }
];
...
const FastFacts = [
  { company: "TIDCO EV Park (Pillaipakkam)", speciality: "Full-stack EV ecosystem (OEMs, battery, testing)" },
  { company: "OMR Tech Belt", speciality: "Charging hubs, software for EV telematics" },
  { company: "Ennore Port–Sriperumbudur Corridor", speciality: "Export & logistics zone for EVs" },
  { company: "Tambaram–Chengalpattu Belt", speciality: "EV component suppliers & logistics EV testing" },
 ];
        ...
        points: [
          {
            ...
            para: [
              <> <strong>EV-first zones:</strong> Marina, T. Nagar, and IT corridors may become EV-only zones</>,
         <> <strong>EV bus fleet:</strong> MTC to roll out 1,500+ e-buses across city routes</>,
         <> <strong>AI-powered traffic + charging optimization</strong> platforms from IIT-M incubators</>,
          <> <strong>Connected vehicle ecosystem </strong>with real-time charging & battery diagnostics</>,
           <>  <strong>Battery recycling & second-life plants </strong> by 2026</>,
                
            ],
            note2:"In Chennai, EV isn’t a buzzword. It’s becoming the backbone of how the city moves.",
              imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
          },
        ],
      },
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              ...
              <p>Chennai is not just catching up with electric mobility — it's quietly leading it. From manufacturing EVs and batteries to building smart charging infra and deep-tech EV startups, Chennai is evolving into India’s EV Capital of the South.
</p>
            </div>
          </div>
        </div>
 ...
 {imageSections.map((section, index) => (
  ...
  <div className="p-4 space-y-6">
      <div className="overflow-x-auto">
        <h2 className="text-2xl font-bold mb-3">Key EV Manufacturers in Chennai</h2>
      ...
      <div className="overflow-x-auto">
        <h2 className="text-2xl font-bold mb-3"> Chennai's EV Startup Ecosystem</h2>
        <table className="min-w-full border border-gray-300 rounded-lg mb-6">
          <thead>
            <tr className="bg-gray-100">
      ...
      <div className="overflow-x-auto">
        <h2 className="text-2xl font-bold mb-3"> Charging Infrastructure in Chennai</h2>
        <table className="min-w-full border border-gray-300 rounded-lg mb-6">
          <thead>
            <tr className="bg-gray-100">
        ...
        <p className="mb-2 text-gray-700 text-center"> Chennai has over 600+ active chargers, with a goal of 1,500 by 2026</p>
      </div>
    </div>
    ...
    <div className="overflow-x-auto my-6">
      ...
      <table className="min-w-full border border-gray-200 divide-y divide-gray-200 text-left mb-10">
        <thead className="bg-gray-100">
          <tr>
            <th className="px-4 py-3 text-sm font-semibold text-gray-700">Zone</th>
