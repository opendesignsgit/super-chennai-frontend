        ...
        points: [
          {
            ...
            para: [
             <>One of India’s highest student densities: over 3,000 schools and 150+ colleges</>,
  <>Presence of elite institutions like IIT Madras, Anna University, SRM, VIT</>,
  <>Huge demand for upskilling, test prep, and hybrid learning post-pandemic</>,
  <>Rich talent pool in engineering, content, and pedagogy</>,
  <>Growing number of startups and incubators focused on ed-tech and learning innovation</>,
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              ...
              <p>Chennai is not just a city of schools and colleges anymore — it's a hotbed of education innovation. From K-12 learning apps to AI-led skilling platforms, Chennai is emerging as South India's EduTech capital, nurturing talent, tools, and transformation.
</p>
            </div>
          </div>
        </div>
