        ...
        points: [
          {
            ...
            para: [
              ...
              <>
                These aren't just apps. They’re innovations that change how industries work at a fundamental level.
              </>,
            ],
        ...
        points: [
          {
            ...
            para: [
              <>
                <strong>IIT Madras Advantage:</strong> With top-tier research centers like RBCDSAI and IITM Research Park, Chennai blends research and entrepreneurship seamlessly.
              </>,
              <>
                <strong>Talent-First City:</strong> A strong pool of AI engineers, data scientists, and robotics experts from leading universities.
              </>,
              <>
                <strong>Affordable & Sustainable:</strong> DeepTech companies here scale without burning cash like other metros.
              </>,
              <>
                <strong>B2B DNA:</strong> Chennai specializes in enterprise-focused tech. Quietly powerful. Globally scalable.
              </>,
            ],
             imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
          },
        ...
        points: [
          {
            ...
            para: [
              <>
                <strong>Uniphore:</strong> Voice AI and automation platform used by enterprises worldwide (Unicorn).
              </>,
              <>
                <strong>Mad Street Den:</strong> Retail and emotion AI platform blending neuroscience with computer vision.
              </>,
              <>
                <strong>Detect Technologies:</strong> AI-powered industrial asset monitoring and predictive maintenance.
              </>,
              <>
                <strong>Flutura:</strong> AI for energy, oil & gas analytics—used by global giants.
              </>,
              <>
                <strong>Xanadu.ai:</strong> Pioneers in applying AI to education and behavioral sciences.
              </>,
              <>
                <strong>GalaxEye:</strong> Building space-tech + AI satellites (incubated at IIT-Madras).
              </>,
              <>
                <strong>Hyperverge:</strong> Facial recognition and digital KYC using deep learning.
              </>,
              <>
                (More startups can be listed in a scrollable, filterable directory.)
              </>,
            ],
             imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
          },
        ...
        points: [
          {
            ...
            para: [
              ...
              <>FinBlue & NASSCOM CoEs – For deep tech incubation & B2B scaling</>,
              <>Government AI Policy Labs – Driving responsible and inclusive AI in Tamil Nadu</>,
              <>Meetups, Hackathons, Accelerators – A growing community of builders</>,
            ],
             imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
          },
        ],
...
const imageSections1 = [
  {
    sectionTitle: "Chennai’s Deep Tech & AI Evolution: From Labs to Unicorns (2005–2025)",
    sectionDesc:
        ...
        points: [
          {
            ...
            para: [
              <><strong>IIT Madras becomes a research powerhouse</strong> – Focus on machine learning, computer vision, and embedded systems begins.</>,
              <>Sastra, Anna University, and CEG foster early AI talent.</>,
              <><strong>MNC R&D centers grow</strong> – Cognizant, TCS, and Accenture invest in data analytics teams.</>,
            ],
            imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
        ...
        points: [
          {
            ...
            para: [
              <><strong>IIT-M launches RBCDSAI</strong> – Research on language models, neural networks, and predictive systems accelerates.</>,
              <>Startups like Flutura and Mad Street Den emerge, applying AI to energy analytics and fashion e-commerce.</>,
              <>First AI meetups and hackathons in Chennai attract coders and PhD researchers.</>,
            ],
            imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
        ...
        points: [
          {
            ...
            para: [
              <>Mad Street Den gains global attention with AI-powered retail tools.</>,
              <>Uniphore grows fast, taking voice AI and speech recognition global.</>,
              <>Deep tech incubators launch at IIT-M Research Park and NASSCOM’s warehouse.</>,
              <>AR/VR, robotics, and NLP startups emerge, carving a niche in computer vision and emotion AI.</>,
            ],
            imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
        ...
        points: [
          {
            ...
            para: [
              <>COVID accelerates automation – AI tools for healthcare, logistics, and remote support boom.</>,
              <>IIT-M open-sources AI models for Tamil and Indian languages, democratizing AI for Bharat.</>,
              <>Global tech companies expand AI teams in Chennai.</>,
              <>Uniphore becomes a unicorn, Chennai’s first deep tech startup to reach $1B+ valuation.</>,
            ],
            imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
        ...
        points: [
          {
            ...
            para: [
              <>LangTech and GenAI boom with Indian-language LLMs and voice-first apps.</>,
              <>AI + Robotics + IoT startups build smart surveillance, drones, and manufacturing automation.</>,
              <>AI policy labs and Responsible AI frameworks emerge from academia and startups.</>,
              <>B2B AI scales across HR automation, fraud detection, and industrial use cases.</>,
            ],
            imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
        ...
        points: [
          {
            ...
            para: [
              <><strong>🇮🇳 Indigenous AI:</strong> Tools and platforms made for Indian languages and challenges.</>,
              <><strong> Academic backbone:</strong> IIT-M, IIIT-DM, CEG, and Anna University drive new research.</>,
              <><strong> Vertical depth:</strong> HealthTech, Retail AI, AgriTech, SpeechTech, and Industrial AI.</>,
              <><strong> Proven exits:</strong> Chennai startups are scaling globally, attracting global investors.</>,
            ],
            imgs: "/images/Work-Images/SubPages/Icons/Business-Permits.svg",
          },
        ],
    ...
    <>
        ...
        <div className="accodoamationBannerContainer">
          <div className="accodoamationBannerText">
            ...
            <div className="breadCrum">
              <Link to="/invest">Invest</Link> - <span> DeepTech & AI Startups in Chennai</span>
            </div>
          </div>
        </div>
      ...
      <div className="visitIntroParaSection detailIntro">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          >
            <p>
             DeepTech & AI Startups in Chennai  </p>
          </div>
          <div className="workIntro">
            <h3>DeepTech & AI Startups in Chennai: Quietly Changing the Game </h3>
            <p>Chennai may not shout, but it builds. And when it comes to DeepTech and Artificial Intelligence, the city is creating technologies that power global industries—silently, efficiently, and intelligently.</p>
<p>From emotion-sensing AI in fashion to voice intelligence that powers call centers around the world, Chennai’s deep tech startups are turning cutting-edge research into real-world impact. These companies are using data, algorithms, robotics, IoT, and machine learning to solve complex problems in health, retail, manufacturing, education, and finance.</p>
<p>Whether you're a founder, a student, an investor, or just someone curious about what’s next—this is the Chennai you need to know.
</p>
          </div>
        </div>
      </div>
    ...
    ${
      index % 3 === 0
        ...
        : "pattern-c"
            ...
            key={index}
          >
       <div class="max-w-7xl mx-auto text-center"><h2 class="text-3xl md:text-4xl font-bold">
