  ...
  points: [
    {
      ...
      imgs: "/images/Invest-Images/invest-icons/Invest-EduTech-icons/Why Chennai for EduTech.svg",
    },
  ],
},
      {
        points: [
          {
            ...
            imgs: "/images/Invest-Images/invest-icons/Invest-EduTech-icons/Notable EduTech Startups in Chennai.svg",
      ...
      //       ],
      //       imgs: "/images/Invest-Images/invest-icons/Invest-EduTech-icons/Test Track Ready.svg",
      ...
      //       ],
      //       imgs: "/images/Invest-Images/invest-icons/Invest-EduTech-icons/EV Push and Policy Support.svg",
      ...
      //       ],
      //       imgs: "/images/Invest-Images/invest-icons/Invest-EduTech-icons/Key Focus Areas of Chennai’s Auto Startups.svg",
      ...
      //       ],
      //       imgs: "/images/Invest-Images/invest-icons/Invest-EduTech-icons/Notable Automotive Startups in Chennai.svg",
      ...
      //       ],
      //       imgs: "/images/Invest-Images/invest-icons/Invest-EduTech-icons/What’s Powering This Movement.svg",
  ...
  return (
    <>
      ...
      <div className="accaodomationBannerSection">
        <img src="/images/Invest-Images/SubPages/edtech.jpg" alt="" />
        <div className="accodoamationBannerContainer">
          <div className="accodoamationBannerText">
            <h3>EduTech Startups in Chennai</h3>
            <div className="breadCrum">
              <Link to="/invest-in-chennai">Invest</Link> - <span> EduTech</span>
            </div>
          </div>
        </div>
      ...
      <div className="visitIntroParaSection detailIntro">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="workIntro">
            <h3>
              {/* EduTech Startups in Chennai:  */}
              Rethinking Learning, the Chennai Way
            </h3>
