...
export default function HealthTechMediTech() {
  ...
  const data = [
    {
      indicator: "Neuberg Diagnostics",
      advantage: "Digital pathology, diagnostics",
      advantage1: "Pan-India presence, Chennai HQAIMLedge",
    },
    {
      indicator: "AIMLedge",
      advantage: "AI-based disease prediction",
      advantage1: "Incubated at IIT-M",
    },
    {
      indicator: "Docturnal",
      advantage: "TB & lung disease via breath tech",
      advantage1: "Portable screening, real-time results",
    },
    {
      indicator: "Adiuvo Diagnostics",
      advantage: "Non-invasive skin diagnostics",
      advantage1: "GWon multiple global MedTech awards",
    },
    {
      indicator: "Ira Reality",
      advantage: "Surgical training via VR/AR",
      advantage1: "Simulation-based education",
    },
    {
      indicator: "MedIoTek",
      advantage: "ARemote patient monitoring IoT",
      advantage1: "Rural + hospital applications",
    },
    {
      indicator: "OcareNeo",
      advantage: "Prenatal care AI platform",
      advantage1: "Emerging as OB-GYN support tool",
    },
    {
      indicator: "Sattva MedTech",
      advantage: "Maternal monitoring (SmartM)",
      advantage1: "Used in PHCs; IIT-M & BIRAC supported",
    },
  ];
  ...
  const data1 = [
    {
      indicator: "Neuberg Diagnostics",
      advantage: "$₹300 Cr+ funding",
      advantage1: "Private equity + strategic partnerships",
    },
    {
      indicator: "Adiuvo Diagnostics",
      advantage: "₹30 Cr+",
      advantage1: "SBIRAC, IIGP, IITM Incubation Cell",
    },
    {
      indicator: "MedIoTek",
      advantage: "₹20 Cr+ grants",
      advantage1: "Government, CSR-backed health initiatives",
    },
    {
      indicator: "Sattva MedTech",
      advantage: "₹10 Cr+",
      advantage1: "BIRAC, ICMR, Grand Challenges Canada",
    },
    {
      indicator: "Docturnal",
      advantage: "₹8 Cr+",
      advantage1: "Gates Foundation, social innovation grants",
    },
  ];
      ...
      tenantInfoSections: [
        {
          points: [
            {
              title: " Why Chennai Leads in HealthTech",
              para: [
                <>
                  Strong clinical ecosystem: Apollo, SRMC, MIOT, Kauvery, and
                  100+ hospitals
                </>,
                <>
                  Top medical talent: AIIMS-like academic institutions, IIT-M +
                  Anna Univ tie-ups
                </>,
                <>Engineering + healthcare synergy: Perfect for MedTech R&D</>,
                <>
                  Rising HealthTech startups with access to real-world test beds
                </>,
                <>
                  Medical tourism + affordability = Global scale, local roots
                </>,
              ],
              imgs: "/images/Invest-Images/invest-icons/Invest-healthtechmeditech/Why Chennai Leads in HealthTech.svg",
            },
          ],
        },
      ],
          ...
          points: [
            {
              ...
              imgs: "/images/Invest-Images/invest-icons/Invest-healthtechmeditech/MedTech Infrastructure & Institutional R&D.svg",
            },
          ],
        },
      ],
  ...
  const imageSections2 = [
    {
      ...
      tenantInfoSections: [
        ...
        },
        {
          points: [
            {
              title: "Trends Driving Growth",
              para: [
                <>AI + Imaging = Faster, more accurate diagnostics</>,
                <>Telemedicine + Remote Monitoring for rural care</>,
                <>Minimally invasive surgery powered by robotics</>,
                <>Predictive analytics for chronic disease management</>,
                <>Biosensor devices for real-time health tracking</>,
              ],
              imgs: "/images/Invest-Images/invest-icons/Invest-healthtechmeditech/Trends Driving Growth.svg",
            },
          ],
        },
        {
          points: [
            {
              title: "The Future of HealthTech in Chennai",
              para: [
                <>HealthTech exports: Chennai is eyeing Global South markets</>,
                <>Last-mile health delivery startups with AI + IoT</>,
                <>Integration of EHR, wearables, and insurance</>,
                <>Focus on women’s health, elder care, and mental wellness</>,
              ],
              imgs: "/images/Invest-Images/invest-icons/Invest-healthtechmeditech/The Future of HealthTech in Chennai.svg",
            },
          ],
        },
      ],
      ...
      <div className="visitIntroParaSection detailIntro">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="workIntro">
            <h3>Where Medical Excellence Meets Tech-Led Disruption</h3>
            <p>
              Chennai has long been India’s healthcare capital, home to
              world-renowned hospitals and medical colleges. Now, it's fast
              becoming a HealthTech and MedTech innovation hub, blending
              clinical legacy with cutting-edge technology — from AI diagnostics
              and robotic surgery to remote care and biosensor innovation.
            </p>
          </div>
        </div>
      </div>
    ...
    ${
      ...
      <div className="container max-w-7xl mx-auto px-4  nightlife investchennaisec">
        ...
        <section className="bg-white py-12 px-4 md:px-8">
          <div className="max-w-6xl mx-auto text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">
              HealthTech & MedTech Startups from Chennai
            </h2>
          </div>
        ...
        <section className="bg-white py-12 px-4 md:px-8">
          <div className="max-w-6xl mx-auto text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">
              Investments in HealthTech – So Far
            </h2>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full border border-gray-200 divide-y divide-gray-200 text-left">
