  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Navigate complex regulations with Law Firms in Chennai that specialize in corporate law, taxation, and income tax in Chennai advisory services."
        />
        <link rel="canonical" href="/invest/law-firms-in-chennai" />
      </Helmet>
      {/*----------------Accodimation-Banner----------- */}
        ...
        <div className="accodoamationBannerContainer">
          <div className="accodoamationBannerText">
            ...
            <div className="breadCrum">
              ...
              <span>Formalities and Regulations</span>{" "}
            </div>
          </div>
        </div>
