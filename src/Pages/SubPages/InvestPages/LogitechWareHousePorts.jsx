...
export default function LogitechWareHousePorts() {
  ...
  const data = [
    {
      ...
      advantage: "Auto logistics, 3PL, just-in-time warehousing",
      advantage1: "2M+ learners; vernacular-first approach",
    },
    {
      indicator: "Periyapalayam – Red Hills",
      advantage: "E-comm, cold storage, food processing",
      advantage1: "$17M+ raised; India + US learner base",
    },
    {
      indicator: "Mambakkam – Mappedu",
      advantage: "Rail-linked logistics parks (NHSRC)",
      advantage1: "Global expansion, Chennai origin",
    },
    {
      indicator: "Ennore – Kattupalli",
      advantage: "Port-centric warehousing & FTWZ (Free Trade Zone)",
      advantage1: "Scaling with corporate partners",
    },
    {
      indicator: "Ponneri (JICA zone)",
      advantage: "1,500-acre logistics SEZ in development",
  ...
  const data1 = [
    {
      indicator: "Amazon & Flipkart",
      advantage: "Multi-million sq. ft. warehouses in Chennai",
      advantage1: "Iron Pillar, Y Combinator, angels",
    },
    {
      indicator: "TVS Logistics",
      advantage: "HQ in Chennai; Global 3PL and SCM leader",
      advantage1: "IITM Incubation, BIRAC, VCs",
    },
    {
      indicator: "Mahindra Logistics",
      advantage: "3PL hubs near Oragadam, warehouse expansion",
      advantage1: "Exit valued at ~$600M",
    },
    {
      indicator: "Allcargo Logistics",
      advantage: "FTWZ and bonded warehousing in North Chennai",
      advantage1: "Bootstrapped, angel-backed",
    },
    {
      indicator: "Indospace, ESR, LOGOS",
      advantage: "Grade A warehousing parks developed",
      advantage1: "Early-stage edtech funders",
    },
    {
      indicator: "Adani Ports",
          ...
          points: [
            {
              ...
              para: [
                <>
                  3 Major Ports: Chennai Port (cargo hub), Ennore/Kamarajar Port
                  (bulk), and Kattupalli Port (containers)
                </>,
                <>
                  Golden Quadrilateral & Chennai-Bengaluru Industrial Corridor
                  (CBIC) connectivity
                </>,
                <>
                  Proximity to factories: Automotives, electronics, textiles,
                  and FMCG
                </>,
                <>
                  Warehousing boom: Oragadam, Sriperumbudur, Periyapalayam,
                  Madurantakam
                </>,
                <>
                  Integrated logistics parks in Mappedu, Ponneri, and NH-16 belt
                </>,
                <>
                  Close to Chennai International Airport’s cargo terminals for
                  air logistics
                </>,
              ],
              imgs: "/images/Invest-Images/invest-icons/Invest-logitechwarehouseports/Why Chennai.svg",
            },
          ],
        },
      ],
          ...
          points: [
            {
              ...
              para: [
                <>Kattupalli Port (Adani) – ₹10,000 Cr+ planned expansion</>,
                <>
                  Chennai Peripheral Ring Road (CPRR) – fast-tracking cargo
                  traffic
                </>,
                <>
                  Dedicated Freight Corridors linking CBIC + Vizhinjam to
                  Chennai
                </>,
                <>Dry ports & FTWZ: At Sriperumbudur, Mappedu, Ponneri</>,
                <>
                  Multimodal Logistics Park: Approved at Mappedu with ₹1,200 Cr+
                  budget
                </>,
              ],
              imgs: "/images/Invest-Images/invest-icons/Invest-logitechwarehouseports/Infrastructure Highlights.svg",
            },
          ],
        },
      ],
          ...
          points: [
            {
              ...
              imgs: "/images/Invest-Images/invest-icons/Invest-logitechwarehouseports/Trends Shaping Chennai’s Logistics Sector.svg",
            },
          ],
        },
        {
          points: [
            {
              ...
              imgs: "/images/Invest-Images/invest-icons/Invest-logitechwarehouseports/Future Growth Outlook.svg",
            },
          ],
        },
      ],
      ...
      <div className="visitIntroParaSection detailIntro">
        <div className="container max-w-7xl mx-auto px-4">
          ...
          <div className="workIntro">
            <h3>Moving India. Powering Global Trade.</h3>
            <p>
              Chennai is a strategic logistics gateway for India — blending port
              infrastructure, industrial corridors, 3PL hubs, and rising demand
              from e-commerce, auto, and manufacturing sectors. With strong
              road-rail-port-air connectivity, Chennai is fast becoming South
              India’s logistics capital.
            </p>
          </div>
        </div>
      </div>
        ...
        <section className="bg-white py-12 px-4 md:px-8">
          <div className="max-w-6xl mx-auto text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">
              Key Logistics Clusters in Chennai
            </h2>
          </div>
