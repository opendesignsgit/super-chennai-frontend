...
export default function EducationInstitutions() {
  ...
  const benefitSections = [
    {
      ...
      benefits: [
        ...
        },
        {
          ...
          para: "Renowned institutions in Chennai's educational landscape consists of the PSBB Group of Schools, Chettinad Vidyashram, and SBOA School & Junior College. ",
    ...
    },
    {
      ...
      sectionDesc:
        "Schools in Chennai provide a range of language choices to serve their diverse linguistic community. ",
  ...
  return (
    <>
        ...
        />
        <link rel="canonical" href="/live/educational-institutions-in-chennai" />
      </Helmet>
      <div>
        {/*----------------- Banner ----------------*/}
          ...
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              ...
              <p>
                ...
                kindergarten to high school and colleges, from
