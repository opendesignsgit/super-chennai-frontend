...
export default function Living() {
  ...
  const benefitSections = [
    {
      sectionTitle: "Living in Chennai: An Introduction",
      sectionDesc:
        "Chennai is a city that welcomes all—with a wide spectrum of housing options tailored to suit diverse lifestyles and budgets. Whether you're a local resident, a relocating professional, or an NRI returning home, Chennai offers homes that align with your needs—be it for rent or ownership. From functional budget apartments to elegant luxury villas, the city blends culture, connectivity, and comfort across every neighborhood",
      image: "/images/Live-Images/SubPages/Rental-Properties-in-Chennai.jpg",
      benefits: [
        {
          id: 1,
          title: "Budget-Friendly Living",
          para: "Rent: Affordable rental options in well-connected areas like Tambaram, Ambattur, Pallikaranai, Triplicane, and West Mambalam. Ideal for students, early-career professionals, and families starting out.",
          para: "Purchase: Entry-level apartments and compact plots offering long-term value—perfect for first-time homebuyers or investors seeking steady growth.",
          imgs: "/images/Live-Images/SubPages/Icons/Economical-Rental-Regions.svg",
        },
        {
          id: 2,
          title: "Mid-Range Living",
          para: "Rent: Well-developed localities like T. Nagar, Vadapalani, Porur, and Velachery offer balanced living—modern conveniences, strong connectivity, and proximity to business hubs.",
          para: "Purchase: Spacious apartments and homes in gated communities that combine comfort, lifestyle amenities, and strategic location—suited for growing families and mid-career professionals.",
          imgs: "/images/Live-Images/SubPages/Icons/Mid-Range-Areas.svg",
        },
        {
          id: 3,
          title: "Premium Living",
          para: "Rent: High-end residences in elite neighborhoods like Boat Club, Poes Garden, Nungambakkam, and ECR. Perfect for diplomats, CXOs, expats, and global travelers seeking luxury and privacy.",
          para: "Purchase: Luxury villas, sea-facing apartments, and iconic addresses with world-class amenities and architecture—crafted for those who expect nothing but the best.",
      ...
      tenantInfoSections: [
        {
          ...
          points: [
            <>
            Know the Market: Explore price trends in different areas—budget-friendly to premium zones.
            </>,
            <>
            Verify Documents: Ensure clear land titles, building approvals, and RERA registration.
            </>,
            <>
            Consider Connectivity: Choose locations with good access to transit, work hubs, and essential services.
            </>,
            <>
            Think Long-Term: Assess future development potential for better ROI.
            </>,
            <>
            Choose Reputed Builders: For transparency, quality, and timely delivery.
            </>,
          ],
        },
        {
          title: "For Tenants:",
          points: [
           <>Understand Advance & Lease Terms: Advances typically range from 5–10 months. Review agreement clauses.</>,
           <>Check Utilities & Amenities: Ensure water, electricity, and maintenance are reliable.</>,
           <>Inspect the Neighborhood: Access to daily needs.</>,
           <>Document Everything: Get a written rental agreement with clearly defined responsibilities.</>,
          ],
        },
      ],
    },
