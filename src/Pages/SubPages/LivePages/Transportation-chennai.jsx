...
export default function Transportationchennai() {
  ...
  const benefitSections = [
    {
      ...
      benefits: [
        ...
        },
        {
          ...
          points: [
    <><strong>Beach to Tambaram – </strong> A high-traffic route linking central Chennai to the southern residential belt</>,  
    <><strong> Chennai Central to Arakkonam   – </strong> Serves the western corridor and key industrial areas</>, 
    <><strong> Tambaram to Chengalpattu  – </strong> Connects southern suburbs to growing satellite towns</>, 
  ...
  const benefitSections1 = [
    ...
    },
    {
      ...
      label: <>To legally drive in Chennai, individuals must apply through the Regional Transport Office (RTO). The process includes a learner’s license, driving test, and document verification. Both two-wheeler and four-wheeler licenses are available to eligible applicants. <a href="https://parivahan.gov.in/parivahan//en"  target="_blank" rel="noopener noreferrer" class="text-voilet-500 underline">Apply for a drivers license </a></>,
      ...
      benefits: [
        {
          ...
          imgs: "/images/Live-Images/SubPages/Icons/Donts.svg",
           points: [
    <>Minimum age is 18 years for motor vehicles (LMV – Light Motor Vehicle)</>,  
    <>For gearless two-wheelers under 50cc, minimum age is 16 years.</>, 
    <>Must hold a valid learner’s license before applying for a permanent license.</>, 
    <>Required documents include proof of age, address, and identity.</>, 
     <>Applicants must pass a driving test conducted by the Regional Transport Office (RTO).</>, 
  ],
   },
   {
          id: 2,
          ...
          imgs: "/images/Live-Images/SubPages/Icons/Donts.svg",
           points: [
    <><strong>Book your RTO slot online in advance </strong>through the official Parivahan or Tamil Nadu RTO portal.</>,  
   <><strong>Carry original documents along with photocopies</strong>— especially Aadhaar, proof of residence, and learner’s license.</>, 
   <><strong>Take the learner’s test seriously  </strong>it’s online but time-bound with multiple-choice questions.</>, 
   <><strong>Choose a trusted driving school  </strong>if you're unfamiliar with city traffic rules or need help navigating RTO formalities.</>, 
   <><strong>Be presentable and respectful at the RTO </strong>your road test could be observed casually too.</>, 
  ],
   },
   {
          id: 3,
          ...
          imgs: "/images/Live-Images/SubPages/Icons/Donts.svg",
           points: [
    <><strong>Don’t rely on middlemen or unofficial agents </strong>promising quick approvals — it's risky and often illegal.</>,  
   <><strong>Don’t arrive late for your driving test slot </strong>— late arrivals may need to rebook and wait weeks.</>, 
   <><strong>Don’t skip lane discipline or indicators during the test  </strong>even a minor mistake can lead to disqualification.</>, 
   <><strong>Don’t assume an automatic pass if you're with a driving school  </strong> RTO officers still assess each candidate individually.</>, 
   <><strong>Don’t forget to pay the fee online and carry the receipt  </strong>missing proof delays the process.
...
const mrtStations = [
  { mo: "Beach", s1: "Chennai Beach", s2: "Chennai Central", s3: "Chennai Central" },
  { mo: "Fort", s1: "Chennai Fort", s2: "Basin Bridge", s3: "Washermanpet" },
  { mo: "Park Town", s1: "Chennai Park", s2: "Vyasarpadi Jeeva", s3: "Royapuram" },
  { mo: "Chintadripet", s1: "Chennai Egmore", s2: "Perambur", s3: "Korukkupet" },
  { mo: "Chepauk", s1: "Chetpet", s2: "Perambur Carriage Works", s3: "Tondiarpet" },
  { mo: "Thiruvallikeni", s1: "Nungambakkam", s2: "Perambur Loco Works", s3: "Tondiarpet Metro" },
  { mo: "Light House", s1: "Kodambakkam", s2: "Villivakkam", s3: "Tiruvottiyur" },
  ...
  { mo: "Greenways Road", s1: "St. Thomas Mount", s2: "Tirumullaivoyal", s3: "" },
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <div className="breadCrum">
                <Link to="/live-in-chennai"> Live </Link> - <a href="">Transportation </a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Transportation</h3>
              <p>
                Public transportation in Chennai is managed by various government bodies, offering an extensive network that connects all parts of the city. Key modes include the Chennai Metro Rail, Local trains, suburban trains, MTC buses, and Mini bus services. The metro is a fast-growing, modern option for daily commuters, while the bus system covers a wide range of routes at affordable fares. Suburban trains link the city to outer zones and neighboring districts, making it easier for thousands of residents to travel efficiently.
              </p>
            </div>
          </div>
        </div>
...
<div className="mapingImage">
      {/* Normal Image */}
      <img  src={imageSrc}   alt="Sample"  className="w-64 small h-64 object-cover rounded-2xl cursor-pointer shadow hover:scale-105 transition-transform"
  ...
  <tbody>
    {mrtStations.map((station, index) => (
      <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
        <td className=" px-2 py-1 border-b">{station.mo || "-"}</td>
        <td className=" px-2 py-1 border-b">{station.s1 || "-"}</td>
        <td className=" px-2 py-1 border-b">{station.s2 || "-"}</td>
        <td className=" px-2 py-1 border-b">{station.s3 || "-"}</td>
      </tr>
    ))}
  </tbody>
</table>
