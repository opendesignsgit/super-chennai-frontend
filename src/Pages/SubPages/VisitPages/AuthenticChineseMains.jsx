...
export default function AuthenticChineseMains() {
  ...
  const detailsections = [
    {
      id: 1,
      title: "Golden Dragon - Nungambakkam (Taj Coromandel)",
      image:
        "/images/Visit-Images/SubPages/Authentic-Chinese-Mains/heights-rooftop-restaurant.jpg",
      // link1: "https://www.toscano.co.in/",
      link2: "https://maps.app.goo.gl/VQewRk6eVT8E9U6m9",
      rating: 4.4,
    },
    {
      id: 2,
      title: "East Coast at Madras Kitchen Company - ECR (Radisson Blu)",
      image:
        "/images/Visit-Images/SubPages/Authentic-Chinese-Mains/east-coast-at-madras-square.jpg",
    ...
    {
      id: 3,
      title: "Soy Soi - Nungambakkam",
      image:
        "/images/Visit-Images/SubPages/Authentic-Chinese-Mains/soy-soi.jpg",
      link1: "https://soysoi.com/",
      link2: "https://maps.app.goo.gl/h6nzRbTYcNXAt6Rd7",
      rating: 4.2,
    },
    {
      id: 4,
      title: "Mainland China - Nungambakkam, Velachery",
      image:
        "/images/Visit-Images/SubPages/Authentic-Chinese-Mains/Mainland China - Nungambakkam, Velachery.jpg",
      //   link1: "https://www.littleitaly.in/",
      link2: "https://maps.app.goo.gl/qQimyB4UCSHVH2s77",
      rating: 4.0,
    },
  ];
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              <h3>Authentic Chinese Mains</h3>
              <div className="breadCrum">
                <Link to="/visit-chennai"> Visit </Link> -{" "}
                <Link to="/food"> Food </Link> -{" "}
                <a href="">Authentic Chinese Mains</a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Authentic Chinese Mains</h3>
              <p>
                Savor traditional fried rice, fiery schezwan dishes, and rich
                gravies made with traditional ingredients and methods.
              </p>
            </div>
          </div>
        </div>
