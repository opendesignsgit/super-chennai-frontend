      ...
      places: [
        {
          ...
          locations: [
            {
              name: " Royapettah",
              link: "https://maps.app.goo.gl/QK6ix5Nr6BhL2bt17",
            },
            {
              name: " Express Avenue",
              link: "https://maps.app.goo.gl/ePg7eyhLpkrgkVuY7",
            },
            {
              name: "PVR Palazzo, Forum Vijaya Mall",
              link: "https://maps.app.goo.gl/ZwiedK3vZbjEUwab7",
            },
            {
              name: " VR Mall",
              link: "https://maps.app.goo.gl/uxbRySratqx4guFJA",
            },
            {
              name: " T Nagar",
              link: "https://maps.app.goo.gl/GAjGTfzhnt2Cz62b9",
            },
            {
              name: " Villivakkam",
              link: "https://maps.app.goo.gl/TojAbAu5Eiind4Xp9",
            },
            {
              name: " Maduravoyal",
              link: "https://maps.app.goo.gl/yssLsZjshshMM4uaA",
            },
            {
              name: " Chandra Metro Mall",
              link: "https://maps.app.goo.gl/E6Fkwcdzm6ayCteu8",
            },
            {
              name: "Chennai City Centre",
              link: "https://maps.app.goo.gl/kKwBNPjDpaorqanw9",
            },
          ],
        },
        // {
        ...
        // },
        {
          ...
          locations: [
            {
              name: " Teynampet",
              link: "https://maps.app.goo.gl/NgAe1gZELdjycR8A6",
            },
            {
              name: "Goethe Institut",
              link: "https://maps.app.goo.gl/Ghwm9XhBQWeBjxgGA",
            },
            {
              name: "Af",
              link: "https://maps.app.goo.gl/HweowBgUQE6iGEd98",
            },
          ],
        },
      ],
      ...
      places: [
        {
          ...
          locations: [
            {
              name: " Mylapore",
              link: "https://maps.app.goo.gl/vXVMNFkvrQXgj74D6",
            },
            {
              name: " Nungambakkam",
              link: "https://maps.app.goo.gl/66Yz3Po9P1gvJcRY9",
            },
            {
              name: "Radio Room, Raja Annamalai Puram",
              link: "https://maps.app.goo.gl/EebuqAeVgBdtkX4c9",
            },
          ],
        },
        // {
      ...
      places: [
        {
          ...
          locations: [
            {
              name: " Injambakkam",
              link: "https://maps.app.goo.gl/eLfjx3HFwMqbRUbX6",
            },
            {
              name: "MGM Dizzee World, Muthukadu",
              link: "https://maps.app.goo.gl/oDFiFXRrzHwtWgdo8",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Marina Beach",
              link: "https://maps.app.goo.gl/8radUJTQ7mkgUR3bA",
            },
            {
              name: "Elliot’s Beach, Besant Nagar",
              link: "https://maps.app.goo.gl/KDmPxvKJQ9cQqBZ96",
            },
            {
              name: "Covelong Beach",
              link: "https://maps.app.goo.gl/qNQy4aLPfgcomqAU9",
            },
          ],
        },
        {
          ...
          locations: [
            {
              ...
              link: "https://maps.app.goo.gl/s1WiGJTe6zDQkXsR6",
            },
            {
            ...
            },
            {
              ...
              link: "https://maps.app.goo.gl/WpgUiiECUuXBq8gB7",
            },
          ],
        },
        {
          ...
          locations: [
            {
              ...
              link: "https://maps.app.goo.gl/iLebGfLZLBAqgvn79",
            },
            {
              name: "Birla Planetarium, Kotturpuram",
              link: "https://maps.app.goo.gl/e2yYPUobrq6eDuKd6",
            },
            {
              name: "DakshinaChitra, Muthukadu",
              link: "https://maps.app.goo.gl/2oYsYCZFqzHKbz91A",
            },
          ],
        },
      ],
          ...
          locations: [
            {
              ...
              link: "https://maps.app.goo.gl/dgAK3H9deGG6H6oN9",
            },
            {
              name: "Ashvita, Mylapore",
              link: "https://maps.app.goo.gl/Qkqa23uUN98jnqB77",
            },
            {
              name: "Writer’s Café, Tharamani",
              link: "https://maps.app.goo.gl/7tB3C5cHCRHzQL5V7",
            },
          ],
        },
        {
          ...
          locations: [
            ...
            {
              name: "Island Grounds",
              link: "https://maps.app.goo.gl/dgpyRS2aXev2xzRp6",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Lalit Kala Akademi, Thousand Lights",
              link: "https://maps.app.goo.gl/oo2NDJHjWwSDs2qR7",
            },
            {
              name: "InKo Centre, Raja Annamalai Puram",
              link: "https://maps.app.goo.gl/YTCygGvAj39HkJBJA",
            },
            {
              name: "Apparao Galleries, Nungambakkam",
              link: "https://maps.app.goo.gl/JfLU7qeh5TT1XRzG7",
            },
          ],
        },
      ],
    },
    {
      ...
      places: [
        ...
        // },
        {
          ...
          locations: [
            {
              name: "Music Academy, Royapettah",
              link: "https://maps.app.goo.gl/ajyP4RsXsHdqPU6GA",
            },
            {
              name: " Besant Nagar",
              link: "https://maps.app.goo.gl/66Yz3Po9P1gvJcRY9",
            ...
            {
              name: "Narada Gana Sabha, Alwarpet",
              link: "https://maps.app.goo.gl/LxruuemMMQre7KDGA",
            },
          ],
        },
        // {
    ...
    <>
      <div>
        ...
        <div className="accaodomationBannerSection">
          <img src="/images/entertainment-banner.jpg" alt="" />
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            >
              <p>
                Entertainent &nbsp; in Chennai &nbsp; Entertainent &nbsp; in
                Chennai
              </p>
            </div>
            <div className="workIntro">
              <h3>Feel the Beat of Chennai</h3>
              <p>
                From silver screens to street vibes — discover cinema, live
                shows, family fun, and weekend escapes across the city.
              </p>
            </div>
          </div>
        </div>
