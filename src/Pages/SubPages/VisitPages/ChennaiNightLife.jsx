  ...
  const nightlifeData = [
    {
      ...
      places: [
        ...
        {
          name: "KooX – Rooftop Asian Grill (Novotel OMR)",
          desc: "Rooftop Asian Grill with chic lounge feel",
          locations: [
            {
              name: "Nandanam",
              link: "https://maps.app.goo.gl/DfcEzXymNPiwf5nSA",
            },
            {
              name: "Sholinganallur, OMR",
              link: "https://maps.app.goo.gl/GFyQyfPu16nGHnXK9",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          locations: [
            {
              name: "T. Nagar",
              link: "https://maps.app.goo.gl/Ubbmmk9zszzEiPt16",
            },
          ],
        },
      ],
    ...
    //         {
    //           name: "Nungambakkam",
    //           link: "https://maps.app.goo.gl/ZdupXuezWVtoXiif8",
    //         },
    //       ],
    //     },
    //     {
    ...
    //         {
    //           name: "Nungambakkam",
    //           link: "https://maps.app.goo.gl/GEAmxwqrHzSkXrUG8",
    //         },
    //       ],
    //     },
    //   ],
    ...
    //         {
    //           name: "Anna Nagar",
    //           link: "https://maps.app.goo.gl/igLoVq6FEbDR3VXW8",
    //         },
    //       ],
    //     },
    //     {
    ...
    //         {
    //           name: "T. Nagar",
    //           link: "https://maps.app.goo.gl/R8paQZktaV7Zqc4u5",
    //         },
    //       ],
    //     },
    //     {
    ...
    //         {
    //           name: "R.A. Puram",
    //           link: "https://maps.app.goo.gl/8LQB4dvHArJVxfdm6",
    //         },
    //       ],
    //     },
    //   ],
    ...
    //         {
    //           name: "R.A. Puram",
    //           link: "https://maps.app.goo.gl/qWZ3v8H25Aom6xCg8",
    //         },
    //       ],
    //     },
    //     {
    ...
    //         {
    //           name: "T. Nagar",
    //           link: "https://maps.app.goo.gl/KmAf6VY4qoEXZFRv5",
    //         },
    //       ],
    //     },
    //   ],
      ...
      places: [
        {
          name: "The Velveteen Rabbit",
          desc: "A beautifully designed space with craft cocktails and a quiet, boho-luxury vibe",
          locations: [{ name: "R.A. Puram", link: "https://maps.app.goo.gl/qWZ3v8H25Aom6xCg8" }],
        },
        {
          name: "Radio Room",
          desc: "Retro-themed restobar with great music, curated drinks, and a fashionable crowd.",
          locations: [{ name: "Somerset Greenways", link: "https://maps.app.goo.gl/RmmWhpM1wzJVyEga9" }],
        },
        {
          name: "The Slate Kitchen & Bar",
          desc: "Sophisticated interiors, global cuisine, and rooftop ambiance",
          locations: [{ name: "Nungambakkam", link: "https://maps.app.goo.gl/mLw4Yz768qTmz9Jv9" }],
        },
        {
          name: "Barracuda Brew",
          desc: "Beach-facing brewpub with continental fare, music nights, and craft beer on tap.",
          locations: [{ name: "ECR", link: "https://maps.app.goo.gl/MSQ5vHJLvVdZbCR79" }],
        },
      ],
    },
    {
      ...
      places: [
        {
          ...
          locations: [{ name: "Mylapore", link: "https://maps.app.goo.gl/xGGjYJ4dWNFhan6J6" }],
        },
        {
          name: "Off The Record",
          desc: "Retro hits, casual vibe, and regular DJ nights",
          locations: [{ name: "Nungambakkam", link: "https://maps.app.goo.gl/ZdupXuezWVtoXiif8" }],
        },
        {
          name: "Black Orchid",
          desc: "Hip atmosphere, cocktails, and dance nights",
          locations: [{ name: "Gopalapuram", link: "https://maps.app.goo.gl/8LQB4dvHArJVxfdm6" }],
        },
        {
          name: "Gatsby 2000",
          desc: "Chennai’s oldest discotheque, retro and electronic vibes",
          locations: [{ name: "Crowne Plaza, Alwarpet", link: "https://maps.app.goo.gl/upKedAjxZkPxm9fm8" }],
        },
      ],
    },
      ...
      places: [
        {
          ...
          locations: [
            ...
            {
              name: "Sholinganallur, Chamiers Road",
              link: "https://maps.app.goo.gl/GFyQyfPu16nGHnXK9",
            },
          ],
        },
        {
          ...
          locations: [{ name: "Velachery Rd", link: "https://maps.app.goo.gl/Chyc3qrGR3PJPL6N8" }],
        },
        // {
        //   name: "SKY",
        //   desc: "Elegant rooftop bar with skyline views",
        //   locations: [{ name: "The Rain Tree, Anna Salai", link: "#" }],
        // },
        {
          name: "The Crown",
          desc: "Classic rooftop with live music and a relaxed setting",
          locations: [{ name: "T. Nagar", link: "https://maps.app.goo.gl/Ubbmmk9zszzEiPt16" }],
        },
        {
          name: "Q Bar",
          desc: "Open-air bar with curated music and a high-energy crowd",
          locations: [{ name: "Guindy", link: "https://maps.app.goo.gl/h6YcaEYeVXkKFbz89" }],
        },
      ],
    },
    {
      ...
      places: [
        ...
        },
        {
          ...
          locations: [
            {
              name: "T. Nagar",
              link: "https://maps.app.goo.gl/m4qiS11PY3EK8J6dA",
            },
          ],
        },
        {
          ...
          locations: [
            {
              ...
              link: "https://maps.app.goo.gl/3BVg281c8dyzCLcF7",
            },
          ],
        },
        {
      ...
      places: [
        ...
        },
        {
          ...
          locations: [
            {
              name: "Palavakkam",
              link: "https://maps.app.goo.gl/4eqBw6KWk7L7p6sB8",
            },
          ],
        },
        // {
        ...
        //   locations: [{ name: "The Park Hotel", link: "#" }],
        // },
      ],
    },

    {
      ...
      places: [
        ...
        {
          name: "Writer’s Café",
          desc: "Quiet café famous for cozy ambiance, books, and comfort food",
          locations: [
            {
              name: "Gopalapuram",
              link: "https://maps.app.goo.gl/iF525uYj5UtSM6dc7",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Periamet",
              link: "https://maps.app.goo.gl/WX3PaRQKuZYw43gh9",
            },
            {
              name: "Shenoy Nagar",
              link: "https://maps.app.goo.gl/14nUhhRk4YUDXnKN7",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Adyar",
              link: "https://maps.app.goo.gl/5TSvn3M25gBTu4GV8",
            },
            {
              name: "Velachery",
              link: "https://maps.app.goo.gl/S1BcUQHvSXVTTSVm9",
            },
            {
              name: "Nungambakkam",
              link: "https://maps.app.goo.gl/4mVNGC85wyLo3bhPA",
            },
            {
              name: "Anna Nagar",
              link: "https://maps.app.goo.gl/dnWYnFPGoPsBy9ULA",
            },
            {
              name: "Royapettah",
              link: "https://maps.app.goo.gl/P76DqhbJzDRJBn3r9",
            },
            {
              name: "Navalur",
              link: "https://maps.app.goo.gl/VzKiwzkda4EjTJKV6",
            },
            {
              name: "Selaiyur",
              link: "https://maps.app.goo.gl/hmrD7geKNQn2jcvA6",
            },
          ],
        },
        {
          name: "Haunted Restaurant",
          desc: "Themed 24-hour café with gaming zones and fast bites",
          locations: [
            {
              name: "Mylapore",
              link: "https://maps.app.goo.gl/sCNfHkP4iNjkXvSa9",
            },
            {
              name: "Anna Nagar",
              link: "https://maps.app.goo.gl/B22SFP64q2yc3ehXA",
            },
            {
              name: "Anna Nagar (Vasanth Colony)",
              link: "https://maps.app.goo.gl/c4GcDpnArjmYDVmP8",
            },
          ],
        },
      ],
