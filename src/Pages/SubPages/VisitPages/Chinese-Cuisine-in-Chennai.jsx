   ...
   const nightlifeData = [
  {
    ...
    places: [
      ...
      },
      {
        ...
        locations: [{ name: "Kotturpuram", link: "#" }],
      },
      {
        name: "Hokkaido",
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <Link to="/visit"> Visit </Link> - <Link to="/food"> Food </Link> - <a href=""> Chinese Cuisine in Chennai </a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          ...
          ref={bgTextRef}
            ...
            <div className="workIntro">
              ...
              <p> Chinese food is a beloved staple in Chennai — whether it's a late-night craving for Hakka noodles or a weekend family feast featuring dim sum and sweet corn soup. The city's Chinese dining scene offers everything from traditional Cantonese flavors to Indo-Chinese fusion delights with bold sauces and fiery stir-fries.
 </p>
<p> Expect bamboo baskets of dumplings, glazed chili tofu, sizzling hot pots, and soy-kissed rice bowls across the city — served in casual cafés, elegant rooftops, and high-end hotel kitchens.</p>
            </div>
          </div>
        </div>
