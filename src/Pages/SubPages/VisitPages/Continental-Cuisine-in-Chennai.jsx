  ...
  },
  {
    ...
    places: [
      ...
      },
      {
        ...
        locations: [{ name: "Royapettah", link: "#" }, { name: "Triplicane", link: "#" }],
      },
     ],
  },
   {
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <Link to="/visit"> Visit </Link> - <Link to="/food"> Food </Link> - <a href=""> Continental Cuisine in Chennai </a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          ...
          ref={bgTextRef}
            ...
            <div className="workIntro">
              <h3>Continental Cuisine in Chennai- Global Comfort with a Gourmet Touch</h3>
              <p>Continental cuisine in Chennai brings together classic European and Western dishes — think grilled meats, creamy pastas, flaky quiches, roasted vegetables, and buttery sauces. Whether it’s a brunch of eggs Benedict, a hearty steak dinner, or a crisp salad with wine, the city offers refined experiences in cozy cafés, fine-dining restaurants, and stylish bistros.
</p>
<p>  Blending French, Italian, Spanish, and Mediterranean influences, Chennai’s continental food scene balances authenticity with local creativity — perfect for casual elegance or business meals with international flair.</p>
            </div>
          </div>
        </div>

    <div className="container max-w-7xl mx-auto px-4 py-8 nightlife">
      <h1 className="text-3xl font-bold mb-10 text-center">Top Continental Restaurants in Chennai</h1>
