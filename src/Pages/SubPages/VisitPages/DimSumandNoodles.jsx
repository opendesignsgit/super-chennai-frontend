...
export default function DimSumandNoodles() {
  ...
  const detailsections = [
    {
      id: 1,
      title: "The Oriental Blossom - Nungambakkam",
      image:
        "/images/Visit-Images/SubPages/Dim-Sum-and-Noodles/The-Oriental-Blossom-Nungambakkam.jpg",
      // link1: "https://www.toscano.co.in/",
      link2: "https://maps.app.goo.gl/wR85rSm5NWSnGz2o9",
      rating: 4.3,
    },
    {
      id: 2,
      title: "Hao Hao - Anna Nagar",
      image:
        "/images/Visit-Images/SubPages/Dim-Sum-and-Noodles/Hao-Hao-Anna-Nagar.jpg",
    ...
    {
      id: 4,
      title: "China Town - Egmore",
      image:
        "/images/Visit-Images/SubPages/Dim-Sum-and-Noodles/ChINA-TOWN-Egmore.jpg",
      //   link1: "https://www.littleitaly.in/",
      link2: "https://maps.app.goo.gl/vavwqTPUY6BvWawS6",
      rating: 4.3,
    },
  ];
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              <h3>Dim Sum and Noodles</h3>
              <div className="breadCrum">
                <Link to="/visit-chennai"> Visit </Link> -{" "}
                <Link to="/food"> Food </Link> -{" "}
                <a href="">Dim Sum and Noodles</a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Dim Sum and Noodles</h3>
              <p>
                Savor a range of tasty noodle dishes, crunchy spring rolls, and
                delicate steamed dumplings that highlight the lighter side of
                Chinese culinary expertise.
              </p>
            </div>
          </div>
        </div>
