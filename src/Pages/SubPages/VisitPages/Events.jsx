...
export default function Events() {
  ...
  return (
    <>
      <Helmet>
        <title>Events in Chennai | Workshops in Chennai</title>
        <meta
          name="description"
          content="Discover the charm of cultural fests, music shows & exhibitions events in Chennai bring together heritage, art & community for unforgettable experiences."
        />
        <link rel="canonical" href="/visit/events-in-chennai" />
      </Helmet>
      <div>
        {/*----------------- Banner ----------------*/}
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <div className="breadCrum">
                <Link to="/visit-chennai"> Visit </Link> - <a href="">Events</a>
              </div>
            </div>
          </div>
