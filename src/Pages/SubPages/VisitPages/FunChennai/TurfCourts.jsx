...
export default function TurfCourts() {
  ...
  return (
    <>
      <Helmet>
        <title>Turf Courts in Chennai : Your Urban Sports Destination</title>
        <meta
          name="description"
          content="Book turf courts in Chennai for football, cricket & more. Enjoy all-weather surfaces, professional lighting & hassle-free online reservations."
        />
        <link
          rel="canonical"
          href="/visit/things-to-do/turf-courts-in-chennai"
        />
      </Helmet>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              ...
              <p>
                Chennai’s turf culture is booming — from early-morning
                footballers to late-night cricket leagues, turf courts have
                become the go-to space for urban sports lovers. With
                professional lighting, all-weather turf, and online booking,
                your game is just a few steps away.
              </p>
            </div>
          </div>
        </div>
