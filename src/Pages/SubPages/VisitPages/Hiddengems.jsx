...
export default function Hiddengems() {
  ...
  return (
    <>
      <Helmet>
        <title>Hidden Places in Chennai | Hidden Spots in Chennai</title>
        <meta
          name="description"
          content="Explore hidden places in Chennai offering untouched beauty, artistic wonders, and cultural charm perfect for travelers seeking unique experiences."
        />
        <link rel="canonical" href="/visit/hidden-places-in-chennai" />
      </Helmet>
      <div>
        {/*----------------- Banner ----------------*/}
