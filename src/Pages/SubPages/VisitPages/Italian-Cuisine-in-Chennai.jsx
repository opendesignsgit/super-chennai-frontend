      ...
      places: [
          ...
          locations: [
            {
              ...
              link: "https://maps.app.goo.gl/wBC1kYCioDRSUjxR6  ",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Besant Nagar",
              link: "https://maps.app.goo.gl/7FHfuxjRmbMPP17E6",
            },
            {
              name: "Anna Nagar",
              link: "https://maps.app.goo.gl/f1fRu6xya4Mz7DW88",
            },
          ],
        },
        // {
        ...
        // },
        {
          ...
          locations: [
            {
              name: "Adyar",
              link: "https://maps.app.goo.gl/bwVZ44cj2RiVBLYd9",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Teynampet",
              link: "https://maps.app.goo.gl/LrhXAM33QmAERAF97",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Velachery",
              link: "https://maps.app.goo.gl/8m9pPgGCTPSz1k8QA",
            },
            {
              name: "Nungambakkam",
              link: "https://maps.app.goo.gl/zKwVkVnbnGNJ5eeM7",
            },
          ],
        },
      ],
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <div className="breadCrum">
                ...
                <a href=""> Italian Cuisine in Chennai </a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              ...
              <p>
                {" "}
                From hand-tossed pizzas to silky pastas and creamy risottos,
                Italian cuisine has found a delicious second home in Chennai.
                Whether you're looking for a candlelit meal with burrata and red
                wine or a casual slice of Neapolitan pizza on the go, the city
                offers a taste of Italy at every price point.
              </p>
              <p>
                {" "}
                Expect authentic ingredients — think extra virgin olive oil,
                sun-dried tomatoes, and fresh basil — served with flair in
                settings that range from open-kitchen pizzerias to rooftop
                trattorias. It’s not just a meal; it’s a celebration of simple,
