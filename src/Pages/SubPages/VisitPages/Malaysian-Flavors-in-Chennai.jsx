        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <Link to="/visit"> Visit </Link> - <Link to="/food"> Food </Link> - <a href=""> Malaysian Flavors in Chennai </a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          ...
          ref={bgTextRef}
            ...
            <div className="workIntro">
              ...
              <p> Nasi Kandar Pelita is celebrated for its rich and flavorful dishes that reflect the multicultural essence of Malaysian cuisine. The restaurant's signature offerings include:
</p>
            </div>
          </div>
        </div>
