...
export default function MexicanCuisineinChennai() {
    ...
    places: [
      {
        ...
        locations: [
          { name: "Teynampet ", link: "#" }, { name: "Egmore ", link: "#" }  
          ],
      },
      {
        name: "La Cabana",
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <Link to="/visit"> Visit </Link> - <Link to="/food"> Food </Link> - <a href=""> Mexican Cuisine in Chennai </a>
              </div>
            </div>
          </div>
 ...
 <p>Mexican cuisine is making a flavorful mark on Chennai’s food scene — with fiery salsas, stuffed burritos, cheesy quesadillas, and crunchy tacos becoming go-to favorites for urban diners. Known for its mix of earthy spices, slow-cooked meats, and fresh produce, Mexican food appeals to those who love both comfort and kick.
 </p>
 <p>Whether you're craving loaded nachos with guacamole or a sizzling fajita platter, Chennai’s Mexican restaurants offer a delicious cross-section of Tex-Mex favorites and authentic Mexican staples in cheerful, casual settings.</p>
            </div>
          </div>
        </div>
