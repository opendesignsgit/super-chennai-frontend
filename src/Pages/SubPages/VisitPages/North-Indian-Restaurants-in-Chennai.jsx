   ...
   const nightlifeData = [
  {
    ...
    places: [
      ...
      },
      {
        ...
        locations: [{ name: "Anna Nagar", link: "#" },{ name: "Nungambakkam", link: "#" }],
      },
     ],
  },
  {
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <Link to="/visit"> Visit </Link> - <Link to="/food"> Food </Link> - <a href=""> North Indian Restaurants in Chennai </a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          ...
          ref={bgTextRef}
            ...
            <div className="workIntro">
              ...
              <p> Chennai’s love for North Indian cuisine runs deep — rich curries, chargrilled kebabs, soft rotis, and comforting dal makhani are staples across the city. Whether you're looking for a festive Punjabi thali, a quiet bowl of butter paneer with naan, or an indulgent Mughlai biryani, Chennai’s food scene brings the North to the South with flair.
</p>
<p> Restaurants range from traditional dhabas and family-run kitchens to elegant rooftop lounges and five-star dining rooms, serving dishes from Delhi, Lucknow, Amritsar, and beyond.
    ...
    <div className="container max-w-7xl mx-auto px-4 py-8 nightlife">
      <h1 className="text-3xl font-bold mb-10 text-center">Top North Indian Restaurants in Chennai</h1>
