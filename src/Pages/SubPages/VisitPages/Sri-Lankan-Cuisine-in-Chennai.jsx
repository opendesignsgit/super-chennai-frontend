   ...
   const nightlifeData = [
  {
    ...
    places: [
      ...
      },
      {
        ...
        locations: [{ name: "Velachery", link: "#" },{ name: "Nungambakkam", link: "#" }],
      },
         {
        name: "Arokkiya Unavu",
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <Link to="/visit"> Visit </Link> - <Link to="/food"> Food </Link> - <a href=""> Sri Lankan Cuisine in Chennai </a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          ...
          ref={bgTextRef}
            ...
            <div className="workIntro">
              ...
              <p> Chennai shares deep cultural and culinary ties with Sri Lanka, and the city’s dining landscape reflects that connection through a small but growing number of authentic Sri Lankan eateries. Expect dishes that burst with bold flavors — rich coconut milk gravies, fiery sambols, and uniquely Sri Lankan staples like string hoppers (idiyappam), kothu roti, and crab curry.
</p>
<p>  These restaurants offer both traditional Jaffna-style Tamil cooking and coastal Sinhalese-inspired fare, often served in a homely setting that celebrates shared roots and cross-border comfort food.
 </p>
            </div>
          </div>
        </div>
