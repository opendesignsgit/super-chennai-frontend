...
export default function TasteofThailandinChennai() {
  ...
  const nightlifeData = [
    {
      category: "Where to Find Thai Food in Chennai",
      places: [
        {
          name: "Benjarong ",
          ...
          locations: [
            {
              name: "Alwarpet",
              link: "https://maps.app.goo.gl/NALvtcNF6ocrUxBw9",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Teynampet",
              link: "https://maps.app.goo.gl/HMRcigs6BtXCtfM58",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Guindy",
              link: "https://maps.app.goo.gl/zCenNKmSFU2S8R916",
            },
          ],
        },
        // {
        ...
        // },
        {
          ...
          locations: [
            {
              name: "Anna Nagar ",
              link: "https://maps.app.goo.gl/QHTEc6516R11auJBA",
            },
          ],
        },
        {
          ...
          locations: [
            {
              name: "Alwarpet",
              link: "https://maps.app.goo.gl/FzKsrcrbVmn4hFVx7",
            },
          ],
        },
        // {
    ...
    <>
      <div>
        ...
        <div className="accaodomationBannerSection">
          <img
            src="images/Visit-Images/SubPages/thai-cuisine-banner.jpg"
            alt=""
          />
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              ...
              <div className="breadCrum">
                ...
                <a href=""> Taste of Thailand in Chennai</a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              ...
              <p>
                Chennai’s growing global palate has warmly embraced Thai
                cuisine, known for its bold flavors and fresh, fragrant
                ingredients. From spicy curries to delicate stir-fries, Thai
                food balances sweet, sour, salty, and spicy in every bite.{" "}
              </p>
              <p>
                Whether you’re indulging in a warm bowl of Tom Yum soup, digging
                into Pad Thai, or savoring rich green and red curries with
                jasmine rice, Chennai offers a delightful variety of Thai dining
                experiences — from upscale fine-dining restaurants to cozy,
                casual cafes.
              </p>
            </div>
          </div>
