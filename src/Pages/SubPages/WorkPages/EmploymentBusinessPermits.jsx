      ...
      tenantInfoSections: [
        {
          points: [
            {
              title: "Key Locations",
              desc: "Key locations include MEPZ SEZ (Tambaram), Mahindra World City SEZ (Chengalpattu), DLF Cybercity SEZ (Manapakkam), Shriram Gateway SEZ, and Chennai Free Trade & Warehousing Zone (FTZ).",
              para: [
                "Ideal For: Export-oriented units, IT/ITES, manufacturing, logistics",
                "Required Licenses/Registrations:",
                "SEZ Unit Approval (from Development Commissioner)",
                "Importer Exporter Code (IEC)",
                "GST Registration (for 0-rated exports)",
                "Environmental Clearance (if applicable)",
                "Fire & Building Safety Certificates",
                "Factory Licence (if manufacturing)",
                "Industry-specific licences (e.g., FSSAI, Drug Licence)",
      ...
      tenantInfoSections: [
        {
          points: [
            {
              title: "Key Locations",
              desc: "Key locations include Mahindra World City DTA.",
              para: [
                "Ideal For: Local market businesses, services, retailers",
                "Required Licenses/Registrations:",
                "Business Entity Registration (Sole Proprietor / LLP / Pvt Ltd)",
                "Trade Licence (from Chennai Corporation)",
                "GST Registration",
                "Shops & Establishment Act Licence",
                "PAN & TAN",
                "Professional Tax (PT)",
                "Labour Department Licences (if applicable)",
                "Industry-specific certifications (FSSAI, etc.)",
      ...
      tenantInfoSections: [
        {
          points: [
            {
              title: "Key Features",
              desc: "Companies can set up export units, manufacturing plants, or service facilities based on their business model.",
              para: [
                "SIPCOT industrial parks like Sriperumbudur, Oragadam, Gummidipoondi, Hosur.",
                "Ideal For: Manufacturing, auto, electronics, heavy industries.",
                "Required Licenses/Registrations:",
                "Allotment from SIPCOT",
                "Factory Licence (Inspector of Factories)",
                "Building Plan Approval (via CMDA/DTCP)",
                "Tamil Nadu Pollution Control Board (TNPCB) Clearance",
                "Fire Safety Certificate",
                "Power and Water Board Connections",
                "GST, Shops Act, PT",
                "Industry-specific licences (Chemical, Pharma, etc.)",
      ...
      tenantInfoSections: [
        {
          points: [
            {
              title: "Key Features",
              desc: "It operates under DTA regulations and is ideal for domestic production, services, and traditional industries.",
              para: [
                "SIDCO Estates like Guindy, Ambattur, Thirumullaivoyal, Thiruvallur, Thirumudivakkam.",
                "Ideal For: MSMEs, small manufacturers, artisans.",
                "Required Licenses/Registrations:",
                "Land/Shed Allotment from SIDCO",
                "MSME/Udyam Registration",
                "GST Registration",
                "Trade Licence (Local Municipal Body)",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="From booming IT parks to vibrant trade and manufacturing, business in Chennai continues to grow, offering endless possibilities for professionals and enterprises."
        />
        <link rel="canonical" href="/work/business-registration-in-chennai" />
      </Helmet>
      <div>
        {/*----------------- Banner ----------------*/}
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h1>Business Registration in Chennai</h1>
              <p>
                Chennai is a thriving hub for commerce, innovation, and skilled
                talent. It boasts robust infrastructure—from industrial estates
                like Ambattur and SEZs such as MEPZ (Madras Export Processing
                Zone), world-class IT parks like TIDEL Park and DLF Cybercity.
                Supported by proactive urban planning via CMDA and streamlined
                governance, Chennai offers efficiency, connectivity, and a
                vibrant ecosystem for every stage of business.
              </p>
            </div>
          </div>
        </div>
...
//             </div>
//             <div className="workIntro">
//               <h3> Business Permits in Chennai</h3>
//               <p>
