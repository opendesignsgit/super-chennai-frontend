      ...
      <div>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3> 
                Where Tradition Meets Trend on Every Street
                </h3>
              <p>
               Chennai offers a retail experience as diverse as the city itself — a place where age-old textile shops stand proudly beside sleek malls, and local street markets buzz just minutes away from luxury boutiques. Whether you're searching for handwoven silks, electronics, gold jewelry, designer fashion, or homegrown brands, Chennai’s shopping scene is an adventure in discovery, craftsmanship, and convenience.
              </p>
              <p>
              From vibrant bazaars to curated lifestyle stores, the city caters to every style, budget, and purpose — all while keeping its cultural flair intact.
              </p>
            </div>
          </div>
        </div>
